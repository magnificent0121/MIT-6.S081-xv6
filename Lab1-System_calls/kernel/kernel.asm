...
0000000080000086 <start>:
{
  ...
  asm volatile("csrw mepc, %0" : : "r" (x));
    ...
    800000aa:	e3e78793          	addi	a5,a5,-450 # 80000ee4 <main>
...
consolewrite(int user_src, uint64 src, int n)
{
  ...
  acquire(&cons.lock);
    ...
    80000110:	b2a080e7          	jalr	-1238(ra) # 80000c36 <acquire>
  for(i = 0; i < n; i++){
    ...
    8000012a:	3aa080e7          	jalr	938(ra) # 800024d0 <either_copyin>
  ...
  release(&cons.lock);
    ...
    80000152:	b9c080e7          	jalr	-1124(ra) # 80000cea <release>
...
consoleread(int user_dst, uint64 dst, int n)
{
  ...
  acquire(&cons.lock);
    ...
    800001a2:	a98080e7          	jalr	-1384(ra) # 80000c36 <acquire>
  while(n > 0){
  ...
  while(n > 0){
    ...
    800001d2:	836080e7          	jalr	-1994(ra) # 80001a04 <myproc>
    ...
    800001e2:	03a080e7          	jalr	58(ra) # 80002218 <sleep>
    while(cons.r == cons.w){
    ...
    8000021e:	260080e7          	jalr	608(ra) # 8000247a <either_copyout>
  ...
  release(&cons.lock);
    ...
    8000023a:	ab4080e7          	jalr	-1356(ra) # 80000cea <release>
  ...
  return target - n;
    ...
    80000250:	a9e080e7          	jalr	-1378(ra) # 80000cea <release>
        return -1;
...
consoleintr(int c)
{
  ...
  acquire(&cons.lock);
    ...
    800002e2:	958080e7          	jalr	-1704(ra) # 80000c36 <acquire>
  ...
  case C('P'):  // Print process list.
    ...
    80000300:	22a080e7          	jalr	554(ra) # 80002526 <procdump>
      }
    }
    break;
  }
  ...
  release(&cons.lock);
    ...
    80000310:	9de080e7          	jalr	-1570(ra) # 80000cea <release>
}
  ...
  switch(c){
    ...
    80000454:	f4e080e7          	jalr	-178(ra) # 8000239e <wakeup>
...
consoleinit(void)
{
  ...
  initlock(&cons.lock, "cons");
    ...
    80000476:	734080e7          	jalr	1844(ra) # 80000ba6 <initlock>
...
0000000080000592 <printf>:
{
  ...
  consputc('x');
    ...
    8000060e:	62c080e7          	jalr	1580(ra) # 80000c36 <acquire>
  ...
  if(locking)
    ...
    80000772:	57c080e7          	jalr	1404(ra) # 80000cea <release>
}
...
printfinit(void)
{
  ...
  initlock(&pr.lock, "pr");
    ...
    80000798:	412080e7          	jalr	1042(ra) # 80000ba6 <initlock>
  pr.locking = 1;
...
uartinit(void)
{
  ...
  initlock(&uart_tx_lock, "uart");
    ...
    800007ee:	3bc080e7          	jalr	956(ra) # 80000ba6 <initlock>
}
...
uartputc_sync(int c)
{
  ...
  push_off();
    ...
    8000080a:	3e4080e7          	jalr	996(ra) # 80000bea <push_off>
  ...
  pop_off();
    ...
    8000083c:	452080e7          	jalr	1106(ra) # 80000c8a <pop_off>
}
    ...
    8000085a:	08f70263          	beq	a4,a5,800008de <uartstart+0x94>
{
    ...
    800008ba:	ae8080e7          	jalr	-1304(ra) # 8000239e <wakeup>
...
00000000800008e0 <uartputc>:
{
  ...
  acquire(&uart_tx_lock);
    ...
    800008fe:	33c080e7          	jalr	828(ra) # 80000c36 <acquire>
  if(panicked){
    ...
    80000954:	8c8080e7          	jalr	-1848(ra) # 80002218 <sleep>
    if(((uart_tx_w + 1) % UART_TX_BUF_SIZE) == uart_tx_r){
    ...
    80000998:	356080e7          	jalr	854(ra) # 80000cea <release>
}
...
uartintr(void)
{
  ...
  acquire(&uart_tx_lock);
    ...
    80000a04:	236080e7          	jalr	566(ra) # 80000c36 <acquire>
  uartstart();
  ...
  release(&uart_tx_lock);
    ...
    80000a16:	2d8080e7          	jalr	728(ra) # 80000cea <release>
}
...
kfree(void *pa)
{
  ...
  memset(pa, 1, PGSIZE);
    ...
    80000a54:	2e2080e7          	jalr	738(ra) # 80000d32 <memset>
  ...
  acquire(&kmem.lock);
    ...
    80000a66:	1d4080e7          	jalr	468(ra) # 80000c36 <acquire>
  ...
  release(&kmem.lock);
    ...
    80000a7a:	274080e7          	jalr	628(ra) # 80000cea <release>
}
...
0000000080000ae4 <kinit>:
{
  ...
  initlock(&kmem.lock, "kmem");
    ...
    80000b00:	0aa080e7          	jalr	170(ra) # 80000ba6 <initlock>
...
kalloc(void)
{
  ...
  acquire(&kmem.lock);
    ...
    80000b38:	102080e7          	jalr	258(ra) # 80000c36 <acquire>
  r = kmem.freelist;
  ...
  release(&kmem.lock);
    ...
    80000b50:	19e080e7          	jalr	414(ra) # 80000cea <release>
  ...
  if(r)
    ...
    80000b5e:	1d8080e7          	jalr	472(ra) # 80000d32 <memset>
  return (void*)r;
}
  ...
  release(&kmem.lock);
    ...
    80000b7a:	174080e7          	jalr	372(ra) # 80000cea <release>
  if(r)
    80000b7e:	b7d5                	j	80000b62 <kalloc+0x42>

0000000080000b80 <freemem_size>:
...
int freemem_size(void){
    ...
    80000b8e:	cb91                	beqz	a5,80000ba2 <freemem_size+0x22>
	int cnt=0;
    80000b90:	4501                	li	a0,0
		cnt++;
    80000b92:	2505                	addiw	a0,a0,1
	for(r=kmem.freelist;r;r=r->next){
    80000b94:	639c                	ld	a5,0(a5)
    80000b96:	fff5                	bnez	a5,80000b92 <freemem_size+0x12>
	}
	int ans=cnt*PGSIZE;
	return ans;
}
    80000b98:	00c5151b          	slliw	a0,a0,0xc
    80000b9c:	6422                	ld	s0,8(sp)
    80000b9e:	0141                	addi	sp,sp,16
    80000ba0:	8082                	ret
	int cnt=0;
    80000ba2:	4501                	li	a0,0
    80000ba4:	bfd5                	j	80000b98 <freemem_size+0x18>
    ...
    80000bc2:	8082                	ret
{
  ...
  r = (lk->locked && lk->cpu == mycpu());
    ...
    80000bd4:	e18080e7          	jalr	-488(ra) # 800019e8 <mycpu>
...
push_off(void)
{
  ...
  mycpu()->noff += 1;
    ...
    80000c2a:	dc2080e7          	jalr	-574(ra) # 800019e8 <mycpu>
...
0000000080000c36 <acquire>:
{
  ...
  lk->cpu = mycpu();
    ...
    80000c6a:	d82080e7          	jalr	-638(ra) # 800019e8 <mycpu>
    ...
    80000c7e:	3f650513          	addi	a0,a0,1014 # 80008070 <digits+0x30>
    80000c82:	00000097          	auipc	ra,0x0
    80000c86:	8c6080e7          	jalr	-1850(ra) # 80000548 <panic>
...
pop_off(void)
{
  ...
  struct cpu *c = mycpu();
    ...
    80000c96:	d56080e7          	jalr	-682(ra) # 800019e8 <mycpu>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80000cce:	3ae50513          	addi	a0,a0,942 # 80008078 <digits+0x38>
    80000cd2:	00000097          	auipc	ra,0x0
    80000cd6:	876080e7          	jalr	-1930(ra) # 80000548 <panic>
    panic("pop_off");
    80000cda:	00007517          	auipc	a0,0x7
    80000cde:	3b650513          	addi	a0,a0,950 # 80008090 <digits+0x50>
    80000ce2:	00000097          	auipc	ra,0x0
    80000ce6:	866080e7          	jalr	-1946(ra) # 80000548 <panic>
...
0000000080000cea <release>:
{
  ...
  pop_off();
    ...
    80000d26:	37650513          	addi	a0,a0,886 # 80008098 <digits+0x58>
    80000d2a:	00000097          	auipc	ra,0x0
    80000d2e:	81e080e7          	jalr	-2018(ra) # 80000548 <panic>
...
memset(void *dst, int c, uint n)
{
  ...
  int i;
  for(i = 0; i < n; i++){
    80000d38:	ce09                	beqz	a2,80000d52 <memset+0x20>
    80000d3a:	87aa                	mv	a5,a0
    80000d3c:	fff6071b          	addiw	a4,a2,-1
    80000d40:	1702                	slli	a4,a4,0x20
    80000d42:	9301                	srli	a4,a4,0x20
    80000d44:	0705                	addi	a4,a4,1
    80000d46:	972a                	add	a4,a4,a0
    cdst[i] = c;
    80000d48:	00b78023          	sb	a1,0(a5)
  for(i = 0; i < n; i++){
    80000d4c:	0785                	addi	a5,a5,1
    80000d4e:	fee79de3          	bne	a5,a4,80000d48 <memset+0x16>
  }
  return dst;
}
...
memmove(void *dst, const void *src, uint n)
{
  ...
  d = dst;
  if(s < d && s + n > d){
    80000d98:	00a5f963          	bgeu	a1,a0,80000daa <memmove+0x18>
    80000d9c:	02061713          	slli	a4,a2,0x20
    80000da0:	9301                	srli	a4,a4,0x20
    80000da2:	00e587b3          	add	a5,a1,a4
    80000da6:	02f56563          	bltu	a0,a5,80000dd0 <memmove+0x3e>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
    ...
    80000dae:	ce11                	beqz	a2,80000dca <memmove+0x38>
    ...
    while(n-- > 0)
    80000dc6:	fed59ae3          	bne	a1,a3,80000dba <memmove+0x28>
  ...
  return dst;
    ...
    80000dd6:	da75                	beqz	a2,80000dca <memmove+0x38>
    ...
    while(n-- > 0)
    80000df0:	fec79ae3          	bne	a5,a2,80000de4 <memmove+0x52>
    80000df4:	bfd9                	j	80000dca <memmove+0x38>
...
strncpy(char *s, const char *t, int n)
{
  ...
  while(n-- > 0 && (*s++ = *t++) != 0)
    ...
    ;
  while(n-- > 0)
    80000e68:	00c05d63          	blez	a2,80000e82 <strncpy+0x38>
    80000e6c:	86ba                	mv	a3,a4
    *s++ = 0;
...
main()
{
  ...
  if(cpuid() == 0){
    ...
    80000ef0:	aec080e7          	jalr	-1300(ra) # 800019d8 <cpuid>
    ...
    80000ef8:	11870713          	addi	a4,a4,280 # 8000900c <started>
  if(cpuid() == 0){
    ...
    80000f0c:	ad0080e7          	jalr	-1328(ra) # 800019d8 <cpuid>
    80000f10:	85aa                	mv	a1,a0
    80000f12:	00007517          	auipc	a0,0x7
    80000f16:	1a650513          	addi	a0,a0,422 # 800080b8 <digits+0x78>
    80000f1a:	fffff097          	auipc	ra,0xfffff
    80000f1e:	678080e7          	jalr	1656(ra) # 80000592 <printf>
    ...
    80000f2e:	792080e7          	jalr	1938(ra) # 800026bc <trapinithart>
    plicinithart();   // ask PLIC for device interrupts
    80000f32:	00005097          	auipc	ra,0x5
    80000f36:	dfe080e7          	jalr	-514(ra) # 80005d30 <plicinithart>
  }

  scheduler();        
    80000f3a:	00001097          	auipc	ra,0x1
    80000f3e:	002080e7          	jalr	2(ra) # 80001f3c <scheduler>
    consoleinit();
    80000f42:	fffff097          	auipc	ra,0xfffff
    80000f46:	518080e7          	jalr	1304(ra) # 8000045a <consoleinit>
    printfinit();
    80000f4a:	00000097          	auipc	ra,0x0
    80000f4e:	82e080e7          	jalr	-2002(ra) # 80000778 <printfinit>
    printf("\n");
    80000f52:	00007517          	auipc	a0,0x7
    80000f56:	17650513          	addi	a0,a0,374 # 800080c8 <digits+0x88>
    80000f5a:	fffff097          	auipc	ra,0xfffff
    80000f5e:	638080e7          	jalr	1592(ra) # 80000592 <printf>
    printf("xv6 kernel is booting\n");
    80000f62:	00007517          	auipc	a0,0x7
    80000f66:	13e50513          	addi	a0,a0,318 # 800080a0 <digits+0x60>
    80000f6a:	fffff097          	auipc	ra,0xfffff
    80000f6e:	628080e7          	jalr	1576(ra) # 80000592 <printf>
    printf("\n");
    80000f72:	00007517          	auipc	a0,0x7
    80000f76:	15650513          	addi	a0,a0,342 # 800080c8 <digits+0x88>
    80000f7a:	fffff097          	auipc	ra,0xfffff
    80000f7e:	618080e7          	jalr	1560(ra) # 80000592 <printf>
    kinit();         // physical page allocator
    80000f82:	00000097          	auipc	ra,0x0
    80000f86:	b62080e7          	jalr	-1182(ra) # 80000ae4 <kinit>
    kvminit();       // create kernel page table
    80000f8a:	00000097          	auipc	ra,0x0
    80000f8e:	2a0080e7          	jalr	672(ra) # 8000122a <kvminit>
    kvminithart();   // turn on paging
    80000f92:	00000097          	auipc	ra,0x0
    80000f96:	068080e7          	jalr	104(ra) # 80000ffa <kvminithart>
    procinit();      // process table
    80000f9a:	00001097          	auipc	ra,0x1
    80000f9e:	96e080e7          	jalr	-1682(ra) # 80001908 <procinit>
    trapinit();      // trap vectors
    80000fa2:	00001097          	auipc	ra,0x1
    80000fa6:	6f2080e7          	jalr	1778(ra) # 80002694 <trapinit>
    trapinithart();  // install kernel trap vector
    80000faa:	00001097          	auipc	ra,0x1
    80000fae:	712080e7          	jalr	1810(ra) # 800026bc <trapinithart>
    plicinit();      // set up interrupt controller
    80000fb2:	00005097          	auipc	ra,0x5
    80000fb6:	d68080e7          	jalr	-664(ra) # 80005d1a <plicinit>
    plicinithart();  // ask PLIC for device interrupts
    80000fba:	00005097          	auipc	ra,0x5
    80000fbe:	d76080e7          	jalr	-650(ra) # 80005d30 <plicinithart>
    binit();         // buffer cache
    80000fc2:	00002097          	auipc	ra,0x2
    80000fc6:	f14080e7          	jalr	-236(ra) # 80002ed6 <binit>
    iinit();         // inode cache
    80000fca:	00002097          	auipc	ra,0x2
    80000fce:	5a4080e7          	jalr	1444(ra) # 8000356e <iinit>
    fileinit();      // file table
    80000fd2:	00003097          	auipc	ra,0x3
    80000fd6:	53e080e7          	jalr	1342(ra) # 80004510 <fileinit>
    virtio_disk_init(); // emulated hard disk
    80000fda:	00005097          	auipc	ra,0x5
    80000fde:	e5e080e7          	jalr	-418(ra) # 80005e38 <virtio_disk_init>
    userinit();      // first user process
    80000fe2:	00001097          	auipc	ra,0x1
    80000fe6:	cec080e7          	jalr	-788(ra) # 80001cce <userinit>
    __sync_synchronize();
    80000fea:	0ff0000f          	fence
    started = 1;
    80000fee:	4785                	li	a5,1
    80000ff0:	00008717          	auipc	a4,0x8
    80000ff4:	00f72e23          	sw	a5,28(a4) # 8000900c <started>
...
kvminithart()
{
  ...
  w_satp(MAKE_SATP(kernel_pagetable));
    ...
    80001004:	0107b783          	ld	a5,16(a5) # 80009010 <kernel_pagetable>
...
walk(pagetable_t pagetable, uint64 va, int alloc)
{
  ...
  if(va >= MAXVA)
    ...
    80001048:	08c50513          	addi	a0,a0,140 # 800080d0 <digits+0x90>
    8000104c:	fffff097          	auipc	ra,0xfffff
    80001050:	4fc080e7          	jalr	1276(ra) # 80000548 <panic>
    ...
    8000105c:	ac8080e7          	jalr	-1336(ra) # 80000b20 <kalloc>
    ...
    8000106c:	cca080e7          	jalr	-822(ra) # 80000d32 <memset>
...
kvmpa(uint64 va)
{
    ...
    80001110:	85aa                	mv	a1,a0
  uint64 off = va % PGSIZE;
    80001112:	1552                	slli	a0,a0,0x34
    80001114:	03455493          	srli	s1,a0,0x34
  pte_t *pte;
  uint64 pa;
  
  pte = walk(kernel_pagetable, va, 0);
    80001118:	4601                	li	a2,0
    8000111a:	00008517          	auipc	a0,0x8
    8000111e:	ef653503          	ld	a0,-266(a0) # 80009010 <kernel_pagetable>
    80001122:	00000097          	auipc	ra,0x0
    80001126:	efc080e7          	jalr	-260(ra) # 8000101e <walk>
  if(pte == 0)
    8000112a:	cd09                	beqz	a0,80001144 <kvmpa+0x3e>
    panic("kvmpa");
  if((*pte & PTE_V) == 0)
    8000112c:	6108                	ld	a0,0(a0)
    8000112e:	00157793          	andi	a5,a0,1
    80001132:	c38d                	beqz	a5,80001154 <kvmpa+0x4e>
    panic("kvmpa");
  pa = PTE2PA(*pte);
    80001134:	8129                	srli	a0,a0,0xa
    80001136:	0532                	slli	a0,a0,0xc
  return pa+off;
}
    80001138:	9526                	add	a0,a0,s1
    8000113a:	60e2                	ld	ra,24(sp)
    8000113c:	6442                	ld	s0,16(sp)
    8000113e:	64a2                	ld	s1,8(sp)
    ...
    80001150:	3fc080e7          	jalr	1020(ra) # 80000548 <panic>
    panic("kvmpa");
...
{
    80001164:	715d                	addi	sp,sp,-80
    80001166:	e486                	sd	ra,72(sp)
    80001168:	e0a2                	sd	s0,64(sp)
    8000116a:	fc26                	sd	s1,56(sp)
    8000116c:	f84a                	sd	s2,48(sp)
    8000116e:	f44e                	sd	s3,40(sp)
    80001170:	f052                	sd	s4,32(sp)
    80001172:	ec56                	sd	s5,24(sp)
    80001174:	e85a                	sd	s6,16(sp)
    80001176:	e45e                	sd	s7,8(sp)
  ...
  a = PGROUNDDOWN(va);
    ...
    *pte = PA2PTE(pa) | perm | PTE_V;
    ...
    800011a4:	e7e080e7          	jalr	-386(ra) # 8000101e <walk>
    800011a8:	c51d                	beqz	a0,800011d6 <mappages+0x72>
    if(*pte & PTE_V)
    800011aa:	611c                	ld	a5,0(a0)
    800011ac:	8b85                	andi	a5,a5,1
    800011ae:	ef81                	bnez	a5,800011c6 <mappages+0x62>
    *pte = PA2PTE(pa) | perm | PTE_V;
    ...
    if(a == last)
    800011be:	03390863          	beq	s2,s3,800011ee <mappages+0x8a>
    a += PGSIZE;
    800011c2:	995e                	add	s2,s2,s7
    if((pte = walk(pagetable, a, 1)) == 0)
    800011c4:	bfc9                	j	80001196 <mappages+0x32>
      panic("remap");
    800011c6:	00007517          	auipc	a0,0x7
    800011ca:	f1a50513          	addi	a0,a0,-230 # 800080e0 <digits+0xa0>
    800011ce:	fffff097          	auipc	ra,0xfffff
    800011d2:	37a080e7          	jalr	890(ra) # 80000548 <panic>
      return -1;
  ...
  return 0;
    ...
    800011f0:	b7e5                	j	800011d8 <mappages+0x74>
...
00000000800011f2 <kvmmap>:
{
    ...
    800011fa:	8736                	mv	a4,a3
  if(mappages(kernel_pagetable, va, sz, pa, perm) != 0)
    800011fc:	86ae                	mv	a3,a1
    800011fe:	85aa                	mv	a1,a0
    80001200:	00008517          	auipc	a0,0x8
    80001204:	e1053503          	ld	a0,-496(a0) # 80009010 <kernel_pagetable>
    80001208:	00000097          	auipc	ra,0x0
    8000120c:	f5c080e7          	jalr	-164(ra) # 80001164 <mappages>
    80001210:	e509                	bnez	a0,8000121a <kvmmap+0x28>
}
    ...
    8000121e:	ece50513          	addi	a0,a0,-306 # 800080e8 <digits+0xa8>
...
000000008000122a <kvminit>:
{
  ...
  kernel_pagetable = (pagetable_t) kalloc();
    ...
    80001238:	8ec080e7          	jalr	-1812(ra) # 80000b20 <kalloc>
    8000123c:	00008797          	auipc	a5,0x8
    80001240:	dca7ba23          	sd	a0,-556(a5) # 80009010 <kernel_pagetable>
  memset(kernel_pagetable, 0, PGSIZE);
    80001244:	6605                	lui	a2,0x1
    80001246:	4581                	li	a1,0
    80001248:	00000097          	auipc	ra,0x0
    8000124c:	aea080e7          	jalr	-1302(ra) # 80000d32 <memset>
  kvmmap(UART0, UART0, PGSIZE, PTE_R | PTE_W);
    80001250:	4699                	li	a3,6
    80001252:	6605                	lui	a2,0x1
    80001254:	100005b7          	lui	a1,0x10000
    80001258:	10000537          	lui	a0,0x10000
    8000125c:	00000097          	auipc	ra,0x0
    80001260:	f96080e7          	jalr	-106(ra) # 800011f2 <kvmmap>
  kvmmap(VIRTIO0, VIRTIO0, PGSIZE, PTE_R | PTE_W);
    80001264:	4699                	li	a3,6
    80001266:	6605                	lui	a2,0x1
    80001268:	100015b7          	lui	a1,0x10001
    8000126c:	10001537          	lui	a0,0x10001
    80001270:	00000097          	auipc	ra,0x0
    80001274:	f82080e7          	jalr	-126(ra) # 800011f2 <kvmmap>
  kvmmap(CLINT, CLINT, 0x10000, PTE_R | PTE_W);
    80001278:	4699                	li	a3,6
    8000127a:	6641                	lui	a2,0x10
    8000127c:	020005b7          	lui	a1,0x2000
    80001280:	02000537          	lui	a0,0x2000
    80001284:	00000097          	auipc	ra,0x0
    80001288:	f6e080e7          	jalr	-146(ra) # 800011f2 <kvmmap>
  kvmmap(PLIC, PLIC, 0x400000, PTE_R | PTE_W);
    8000128c:	4699                	li	a3,6
    8000128e:	00400637          	lui	a2,0x400
    80001292:	0c0005b7          	lui	a1,0xc000
    80001296:	0c000537          	lui	a0,0xc000
    8000129a:	00000097          	auipc	ra,0x0
    8000129e:	f58080e7          	jalr	-168(ra) # 800011f2 <kvmmap>
  kvmmap(KERNBASE, KERNBASE, (uint64)etext-KERNBASE, PTE_R | PTE_X);
    800012a2:	00007497          	auipc	s1,0x7
    800012a6:	d5e48493          	addi	s1,s1,-674 # 80008000 <etext>
    800012aa:	46a9                	li	a3,10
    800012ac:	80007617          	auipc	a2,0x80007
    800012b0:	d5460613          	addi	a2,a2,-684 # 8000 <_entry-0x7fff8000>
    800012b4:	4585                	li	a1,1
    800012b6:	05fe                	slli	a1,a1,0x1f
  ...
  kvmmap((uint64)etext, (uint64)etext, PHYSTOP-(uint64)etext, PTE_R | PTE_W);
    ...
    800012c4:	4645                	li	a2,17
    800012c6:	066e                	slli	a2,a2,0x1b
    800012c8:	8e05                	sub	a2,a2,s1
    800012ca:	85a6                	mv	a1,s1
    800012cc:	8526                	mv	a0,s1
    800012ce:	00000097          	auipc	ra,0x0
    800012d2:	f24080e7          	jalr	-220(ra) # 800011f2 <kvmmap>
  kvmmap(TRAMPOLINE, (uint64)trampoline, PGSIZE, PTE_R | PTE_X);
    800012d6:	46a9                	li	a3,10
    800012d8:	6605                	lui	a2,0x1
    800012da:	00006597          	auipc	a1,0x6
    800012de:	d2658593          	addi	a1,a1,-730 # 80007000 <_trampoline>
    800012e2:	04000537          	lui	a0,0x4000
    800012e6:	157d                	addi	a0,a0,-1
    800012e8:	0532                	slli	a0,a0,0xc
    800012ea:	00000097          	auipc	ra,0x0
    800012ee:	f08080e7          	jalr	-248(ra) # 800011f2 <kvmmap>
}
...
uvmunmap(pagetable_t pagetable, uint64 va, uint64 npages, int do_free)
{
  ...
  for(a = va; a < va + npages*PGSIZE; a += PGSIZE){
    ...
    800013a2:	c80080e7          	jalr	-896(ra) # 8000101e <walk>
...
uvmcreate()
{
  ...
  pagetable = (pagetable_t) kalloc();
    ...
    800013ce:	756080e7          	jalr	1878(ra) # 80000b20 <kalloc>
  ...
  memset(pagetable, 0, PGSIZE);
    ...
    800013de:	958080e7          	jalr	-1704(ra) # 80000d32 <memset>
  return pagetable;
}
...
uvminit(pagetable_t pagetable, uchar *src, uint sz)
{
  ...
  mappages(pagetable, 0, PGSIZE, (uint64)mem, PTE_W|PTE_R|PTE_X|PTE_U);
    ...
    8000142e:	d3a080e7          	jalr	-710(ra) # 80001164 <mappages>
  memmove(mem, src, sz);
    80001432:	8626                	mv	a2,s1
    80001434:	85ce                	mv	a1,s3
    80001436:	854a                	mv	a0,s2
    80001438:	00000097          	auipc	ra,0x0
    8000143c:	95a080e7          	jalr	-1702(ra) # 80000d92 <memmove>
}
    ...
    80001454:	cf850513          	addi	a0,a0,-776 # 80008148 <digits+0x108>
...
uvmdealloc(pagetable_t pagetable, uint64 oldsz, uint64 newsz)
{
  ...
  if(PGROUNDUP(newsz) < PGROUNDUP(oldsz)){
    ...
    8000147a:	767d                	lui	a2,0xfffff
    8000147c:	8f71                	and	a4,a4,a2
    8000147e:	97ae                	add	a5,a5,a1
    80001480:	8ff1                	and	a5,a5,a2
  ...
  return newsz;
    ...
    800014a2:	e5e080e7          	jalr	-418(ra) # 800012fc <uvmunmap>
    800014a6:	b7c5                	j	80001486 <uvmdealloc+0x26>

00000000800014a8 <uvmalloc>:
  if(newsz < oldsz)
    800014a8:	0ab66163          	bltu	a2,a1,8000154a <uvmalloc+0xa2>
{
    800014ac:	7139                	addi	sp,sp,-64
    800014ae:	fc06                	sd	ra,56(sp)
    800014b0:	f822                	sd	s0,48(sp)
    800014b2:	f426                	sd	s1,40(sp)
    800014b4:	f04a                	sd	s2,32(sp)
    800014b6:	ec4e                	sd	s3,24(sp)
    800014b8:	e852                	sd	s4,16(sp)
    800014ba:	e456                	sd	s5,8(sp)
    800014bc:	0080                	addi	s0,sp,64
    800014be:	8aaa                	mv	s5,a0
    800014c0:	8a32                	mv	s4,a2
  oldsz = PGROUNDUP(oldsz);
    800014c2:	6985                	lui	s3,0x1
    800014c4:	19fd                	addi	s3,s3,-1
    800014c6:	95ce                	add	a1,a1,s3
    800014c8:	79fd                	lui	s3,0xfffff
    800014ca:	0135f9b3          	and	s3,a1,s3
  for(a = oldsz; a < newsz; a += PGSIZE){
    800014ce:	08c9f063          	bgeu	s3,a2,8000154e <uvmalloc+0xa6>
    800014d2:	894e                	mv	s2,s3
    mem = kalloc();
    800014d4:	fffff097          	auipc	ra,0xfffff
    800014d8:	64c080e7          	jalr	1612(ra) # 80000b20 <kalloc>
    800014dc:	84aa                	mv	s1,a0
    if(mem == 0){
    800014de:	c51d                	beqz	a0,8000150c <uvmalloc+0x64>
    memset(mem, 0, PGSIZE);
    800014e0:	6605                	lui	a2,0x1
    800014e2:	4581                	li	a1,0
    800014e4:	00000097          	auipc	ra,0x0
    800014e8:	84e080e7          	jalr	-1970(ra) # 80000d32 <memset>
    ...
    800014fa:	c6e080e7          	jalr	-914(ra) # 80001164 <mappages>
    800014fe:	e905                	bnez	a0,8000152e <uvmalloc+0x86>
  for(a = oldsz; a < newsz; a += PGSIZE){
    80001500:	6785                	lui	a5,0x1
    80001502:	993e                	add	s2,s2,a5
    80001504:	fd4968e3          	bltu	s2,s4,800014d4 <uvmalloc+0x2c>
  return newsz;
    80001508:	8552                	mv	a0,s4
    8000150a:	a809                	j	8000151c <uvmalloc+0x74>
      uvmdealloc(pagetable, a, oldsz);
    8000150c:	864e                	mv	a2,s3
    8000150e:	85ca                	mv	a1,s2
    80001510:	8556                	mv	a0,s5
    80001512:	00000097          	auipc	ra,0x0
    80001516:	f4e080e7          	jalr	-178(ra) # 80001460 <uvmdealloc>
      return 0;
    ...
    80001534:	4f4080e7          	jalr	1268(ra) # 80000a24 <kfree>
      uvmdealloc(pagetable, a, oldsz);
    80001538:	864e                	mv	a2,s3
    8000153a:	85ca                	mv	a1,s2
    8000153c:	8556                	mv	a0,s5
    8000153e:	00000097          	auipc	ra,0x0
    80001542:	f22080e7          	jalr	-222(ra) # 80001460 <uvmdealloc>
      return 0;
    80001546:	4501                	li	a0,0
    80001548:	bfd1                	j	8000151c <uvmalloc+0x74>
    return oldsz;
    8000154a:	852e                	mv	a0,a1
}
    8000154c:	8082                	ret
  return newsz;
    8000154e:	8532                	mv	a0,a2
    80001550:	b7f1                	j	8000151c <uvmalloc+0x74>

0000000080001552 <freewalk>:
...
freewalk(pagetable_t pagetable)
{
    ...
    80001562:	8a2a                	mv	s4,a0
  // there are 2^9 = 512 PTEs in a page table.
  for(int i = 0; i < 512; i++){
    80001564:	84aa                	mv	s1,a0
    80001566:	6905                	lui	s2,0x1
    80001568:	992a                	add	s2,s2,a0
    pte_t pte = pagetable[i];
    if((pte & PTE_V) && (pte & (PTE_R|PTE_W|PTE_X)) == 0){
    8000156a:	4985                	li	s3,1
    8000156c:	a821                	j	80001584 <freewalk+0x32>
      // this PTE points to a lower-level page table.
      uint64 child = PTE2PA(pte);
    8000156e:	8129                	srli	a0,a0,0xa
      freewalk((pagetable_t)child);
    80001570:	0532                	slli	a0,a0,0xc
    80001572:	00000097          	auipc	ra,0x0
    80001576:	fe0080e7          	jalr	-32(ra) # 80001552 <freewalk>
      pagetable[i] = 0;
    8000157a:	0004b023          	sd	zero,0(s1)
  for(int i = 0; i < 512; i++){
    8000157e:	04a1                	addi	s1,s1,8
    80001580:	03248163          	beq	s1,s2,800015a2 <freewalk+0x50>
    pte_t pte = pagetable[i];
    80001584:	6088                	ld	a0,0(s1)
    if((pte & PTE_V) && (pte & (PTE_R|PTE_W|PTE_X)) == 0){
    80001586:	00f57793          	andi	a5,a0,15
    8000158a:	ff3782e3          	beq	a5,s3,8000156e <freewalk+0x1c>
    } else if(pte & PTE_V){
    8000158e:	8905                	andi	a0,a0,1
    80001590:	d57d                	beqz	a0,8000157e <freewalk+0x2c>
      panic("freewalk: leaf");
    80001592:	00007517          	auipc	a0,0x7
    80001596:	bd650513          	addi	a0,a0,-1066 # 80008168 <digits+0x128>
    8000159a:	fffff097          	auipc	ra,0xfffff
    8000159e:	fae080e7          	jalr	-82(ra) # 80000548 <panic>
    }
  }
  kfree((void*)pagetable);
    800015a2:	8552                	mv	a0,s4
    800015a4:	fffff097          	auipc	ra,0xfffff
    800015a8:	480080e7          	jalr	1152(ra) # 80000a24 <kfree>
}
...
uvmfree(pagetable_t pagetable, uint64 sz)
{
  ...
  freewalk(pagetable);
    ...
    800015d0:	f86080e7          	jalr	-122(ra) # 80001552 <freewalk>
}
    ...
    800015e2:	962e                	add	a2,a2,a1
    800015e4:	4685                	li	a3,1
    800015e6:	8231                	srli	a2,a2,0xc
    800015e8:	4581                	li	a1,0
    800015ea:	00000097          	auipc	ra,0x0
    800015ee:	d12080e7          	jalr	-750(ra) # 800012fc <uvmunmap>
    800015f2:	bfe1                	j	800015ca <uvmfree+0xe>
...
00000000800015f4 <uvmcopy>:
  ...
  for(i = 0; i < sz; i += PGSIZE){
    800015f4:	c679                	beqz	a2,800016c2 <uvmcopy+0xce>
{
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    8000161e:	a04080e7          	jalr	-1532(ra) # 8000101e <walk>
    ...
    8000163c:	4e8080e7          	jalr	1256(ra) # 80000b20 <kalloc>
    ...
    8000164c:	74a080e7          	jalr	1866(ra) # 80000d92 <memmove>
    ...
    8000165e:	b0a080e7          	jalr	-1270(ra) # 80001164 <mappages>
 ...
 err:
  uvmunmap(new, 0, i / PGSIZE, 1);
    ...
    8000169a:	00c9d613          	srli	a2,s3,0xc
    8000169e:	4581                	li	a1,0
    800016a0:	8556                	mv	a0,s5
    800016a2:	00000097          	auipc	ra,0x0
    800016a6:	c5a080e7          	jalr	-934(ra) # 800012fc <uvmunmap>
  return -1;
...
uvmclear(pagetable_t pagetable, uint64 va)
{
    ...
    800016c8:	e406                	sd	ra,8(sp)
    800016ca:	e022                	sd	s0,0(sp)
    800016cc:	0800                	addi	s0,sp,16
  pte_t *pte;
  
  pte = walk(pagetable, va, 0);
    800016ce:	4601                	li	a2,0
    800016d0:	00000097          	auipc	ra,0x0
    800016d4:	94e080e7          	jalr	-1714(ra) # 8000101e <walk>
  if(pte == 0)
    800016d8:	c901                	beqz	a0,800016e8 <uvmclear+0x22>
    panic("uvmclear");
  *pte &= ~PTE_U;
    800016da:	611c                	ld	a5,0(a0)
    800016dc:	9bbd                	andi	a5,a5,-17
    800016de:	e11c                	sd	a5,0(a0)
}
    ...
    800016ec:	ad050513          	addi	a0,a0,-1328 # 800081b8 <digits+0x178>
    800016f0:	fffff097          	auipc	ra,0xfffff
    800016f4:	e58080e7          	jalr	-424(ra) # 80000548 <panic>

00000000800016f8 <copyout>:
int
copyout(pagetable_t pagetable, uint64 dstva, char *src, uint64 len)
{
  ...
  while(len > 0){
    800016f8:	c6bd                	beqz	a3,80001766 <copyout+0x6e>
{
    ...
    8000171e:	a015                	j	80001742 <copyout+0x4a>
    if(n > len)
      n = len;
    memmove((void *)(pa0 + (dstva - va0)), src, n);
    80001720:	9562                	add	a0,a0,s8
    80001722:	0004861b          	sext.w	a2,s1
    80001726:	85d2                	mv	a1,s4
    80001728:	41250533          	sub	a0,a0,s2
    8000172c:	fffff097          	auipc	ra,0xfffff
    80001730:	666080e7          	jalr	1638(ra) # 80000d92 <memmove>
  ...
  while(len > 0){
    8000173e:	02098263          	beqz	s3,80001762 <copyout+0x6a>
    va0 = PGROUNDDOWN(dstva);
    ...
    8000174e:	97a080e7          	jalr	-1670(ra) # 800010c4 <walkaddr>
    if(pa0 == 0)
    80001752:	cd01                	beqz	a0,8000176a <copyout+0x72>
    n = PGSIZE - (dstva - va0);
    80001754:	418904b3          	sub	s1,s2,s8
    80001758:	94d6                	add	s1,s1,s5
    if(n > len)
    8000175a:	fc99f3e3          	bgeu	s3,s1,80001720 <copyout+0x28>
    8000175e:	84ce                	mv	s1,s3
    80001760:	b7c1                	j	80001720 <copyout+0x28>
  }
  return 0;
    80001762:	4501                	li	a0,0
    80001764:	a021                	j	8000176c <copyout+0x74>
...
copyin(pagetable_t pagetable, char *dst, uint64 srcva, uint64 len)
{
  ...
  while(len > 0){
    80001784:	c6bd                	beqz	a3,800017f2 <copyin+0x6e>
{
    ...
    8000179a:	e062                	sd	s8,0(sp)
    8000179c:	0880                	addi	s0,sp,80
    8000179e:	8b2a                	mv	s6,a0
    800017a0:	8a2e                	mv	s4,a1
    800017a2:	8c32                	mv	s8,a2
    800017a4:	89b6                	mv	s3,a3
    va0 = PGROUNDDOWN(srcva);
    800017a6:	7bfd                	lui	s7,0xfffff
    pa0 = walkaddr(pagetable, va0);
    if(pa0 == 0)
      return -1;
    n = PGSIZE - (srcva - va0);
    800017a8:	6a85                	lui	s5,0x1
    800017aa:	a015                	j	800017ce <copyin+0x4a>
    if(n > len)
      n = len;
    memmove(dst, (void *)(pa0 + (srcva - va0)), n);
    800017ac:	9562                	add	a0,a0,s8
    800017ae:	0004861b          	sext.w	a2,s1
    800017b2:	412505b3          	sub	a1,a0,s2
    800017b6:	8552                	mv	a0,s4
    800017b8:	fffff097          	auipc	ra,0xfffff
    800017bc:	5da080e7          	jalr	1498(ra) # 80000d92 <memmove>

    len -= n;
    800017c0:	409989b3          	sub	s3,s3,s1
    dst += n;
    800017c4:	9a26                	add	s4,s4,s1
    srcva = va0 + PGSIZE;
    800017c6:	01590c33          	add	s8,s2,s5
  while(len > 0){
    800017ca:	02098263          	beqz	s3,800017ee <copyin+0x6a>
    va0 = PGROUNDDOWN(srcva);
    800017ce:	017c7933          	and	s2,s8,s7
    pa0 = walkaddr(pagetable, va0);
    800017d2:	85ca                	mv	a1,s2
    800017d4:	855a                	mv	a0,s6
    800017d6:	00000097          	auipc	ra,0x0
    800017da:	8ee080e7          	jalr	-1810(ra) # 800010c4 <walkaddr>
    if(pa0 == 0)
    800017de:	cd01                	beqz	a0,800017f6 <copyin+0x72>
    n = PGSIZE - (srcva - va0);
    800017e0:	418904b3          	sub	s1,s2,s8
    800017e4:	94d6                	add	s1,s1,s5
    if(n > len)
    800017e6:	fc99f3e3          	bgeu	s3,s1,800017ac <copyin+0x28>
    800017ea:	84ce                	mv	s1,s3
    800017ec:	b7c1                	j	800017ac <copyin+0x28>
  }
  return 0;
    800017ee:	4501                	li	a0,0
    800017f0:	a021                	j	800017f8 <copyin+0x74>
...
copyinstr(pagetable_t pagetable, char *dst, uint64 srcva, uint64 max)
{
  ...
  while(got_null == 0 && max > 0){
    80001810:	c6c5                	beqz	a3,800018b8 <copyinstr+0xa8>
{
    ...
    80001828:	8a2a                	mv	s4,a0
    8000182a:	8b2e                	mv	s6,a1
    8000182c:	8bb2                	mv	s7,a2
    8000182e:	84b6                	mv	s1,a3
    va0 = PGROUNDDOWN(srcva);
    80001830:	7afd                	lui	s5,0xfffff
    pa0 = walkaddr(pagetable, va0);
    if(pa0 == 0)
      return -1;
    n = PGSIZE - (srcva - va0);
    80001832:	6985                	lui	s3,0x1
    80001834:	a035                	j	80001860 <copyinstr+0x50>
      n = max;
    ...
    while(n > 0){
      if(*p == '\0'){
        *dst = '\0';
    80001836:	00078023          	sb	zero,0(a5) # 1000 <_entry-0x7ffff000>
    8000183a:	4785                	li	a5,1
      dst++;
    }
  ...
  if(got_null){
    ...
    80001858:	8082                	ret
    srcva = va0 + PGSIZE;
    8000185a:	01390bb3          	add	s7,s2,s3
  while(got_null == 0 && max > 0){
    8000185e:	c8a9                	beqz	s1,800018b0 <copyinstr+0xa0>
    va0 = PGROUNDDOWN(srcva);
    80001860:	015bf933          	and	s2,s7,s5
    pa0 = walkaddr(pagetable, va0);
    80001864:	85ca                	mv	a1,s2
    80001866:	8552                	mv	a0,s4
    80001868:	00000097          	auipc	ra,0x0
    8000186c:	85c080e7          	jalr	-1956(ra) # 800010c4 <walkaddr>
    if(pa0 == 0)
    80001870:	c131                	beqz	a0,800018b4 <copyinstr+0xa4>
    n = PGSIZE - (srcva - va0);
    80001872:	41790833          	sub	a6,s2,s7
    80001876:	984e                	add	a6,a6,s3
    if(n > max)
    80001878:	0104f363          	bgeu	s1,a6,8000187e <copyinstr+0x6e>
    8000187c:	8826                	mv	a6,s1
    char *p = (char *) (pa0 + (srcva - va0));
    8000187e:	955e                	add	a0,a0,s7
    80001880:	41250533          	sub	a0,a0,s2
    while(n > 0){
    80001884:	fc080be3          	beqz	a6,8000185a <copyinstr+0x4a>
    80001888:	985a                	add	a6,a6,s6
    8000188a:	87da                	mv	a5,s6
      if(*p == '\0'){
    8000188c:	41650633          	sub	a2,a0,s6
    80001890:	14fd                	addi	s1,s1,-1
    80001892:	9b26                	add	s6,s6,s1
    80001894:	00f60733          	add	a4,a2,a5
    80001898:	00074703          	lbu	a4,0(a4) # fffffffffffff000 <end+0xffffffff7ffd9000>
    8000189c:	df49                	beqz	a4,80001836 <copyinstr+0x26>
        *dst = *p;
    8000189e:	00e78023          	sb	a4,0(a5)
      --max;
    800018a2:	40fb04b3          	sub	s1,s6,a5
      dst++;
    800018a6:	0785                	addi	a5,a5,1
    while(n > 0){
    800018a8:	ff0796e3          	bne	a5,a6,80001894 <copyinstr+0x84>
      dst++;
    800018ac:	8b42                	mv	s6,a6
    800018ae:	b775                	j	8000185a <copyinstr+0x4a>
    800018b0:	4781                	li	a5,0
    800018b2:	b769                	j	8000183c <copyinstr+0x2c>
      return -1;
    800018b4:	557d                	li	a0,-1
    800018b6:	b779                	j	80001844 <copyinstr+0x34>
  int got_null = 0;
    800018b8:	4781                	li	a5,0
  if(got_null){
    800018ba:	0017b793          	seqz	a5,a5
    800018be:	40f00533          	neg	a0,a5
}
    800018c2:	8082                	ret

00000000800018c4 <wakeup1>:
...
wakeup1(struct proc *p)
{
  ...
  if(!holding(&p->lock))
    ...
    800018d4:	2ec080e7          	jalr	748(ra) # 80000bbc <holding>
    800018d8:	c909                	beqz	a0,800018ea <wakeup1+0x26>
    panic("wakeup1");
  if(p->chan == p && p->state == SLEEPING) {
    800018da:	749c                	ld	a5,40(s1)
    800018dc:	00978f63          	beq	a5,s1,800018fa <wakeup1+0x36>
    p->state = RUNNABLE;
  }
}
    ...
    800018ee:	8de50513          	addi	a0,a0,-1826 # 800081c8 <digits+0x188>
    800018f2:	fffff097          	auipc	ra,0xfffff
    800018f6:	c56080e7          	jalr	-938(ra) # 80000548 <panic>
  if(p->chan == p && p->state == SLEEPING) {
    800018fa:	4c98                	lw	a4,24(s1)
    800018fc:	4785                	li	a5,1
    800018fe:	fef711e3          	bne	a4,a5,800018e0 <wakeup1+0x1c>
    p->state = RUNNABLE;
    80001902:	4789                	li	a5,2
    80001904:	cc9c                	sw	a5,24(s1)
}
    80001906:	bfe9                	j	800018e0 <wakeup1+0x1c>
...
0000000080001908 <procinit>:
{
  ...
  initlock(&pid_lock, "nextpid");
    ...
    80001922:	8b258593          	addi	a1,a1,-1870 # 800081d0 <digits+0x190>
    80001926:	00010517          	auipc	a0,0x10
    8000192a:	02a50513          	addi	a0,a0,42 # 80011950 <pid_lock>
    8000192e:	fffff097          	auipc	ra,0xfffff
    80001932:	278080e7          	jalr	632(ra) # 80000ba6 <initlock>
  for(p = proc; p < &proc[NPROC]; p++) {
    80001936:	00010917          	auipc	s2,0x10
    8000193a:	43290913          	addi	s2,s2,1074 # 80011d68 <proc>
      initlock(&p->lock, "proc");
    8000193e:	00007b97          	auipc	s7,0x7
    80001942:	89ab8b93          	addi	s7,s7,-1894 # 800081d8 <digits+0x198>
      uint64 va = KSTACK((int) (p - proc));
    80001946:	8b4a                	mv	s6,s2
    80001948:	00006a97          	auipc	s5,0x6
    8000194c:	6b8a8a93          	addi	s5,s5,1720 # 80008000 <etext>
    80001950:	040009b7          	lui	s3,0x4000
    80001954:	19fd                	addi	s3,s3,-1
    80001956:	09b2                	slli	s3,s3,0xc
  for(p = proc; p < &proc[NPROC]; p++) {
    80001958:	00016a17          	auipc	s4,0x16
    8000195c:	010a0a13          	addi	s4,s4,16 # 80017968 <tickslock>
      initlock(&p->lock, "proc");
    80001960:	85de                	mv	a1,s7
    80001962:	854a                	mv	a0,s2
    80001964:	fffff097          	auipc	ra,0xfffff
    80001968:	242080e7          	jalr	578(ra) # 80000ba6 <initlock>
      char *pa = kalloc();
    8000196c:	fffff097          	auipc	ra,0xfffff
    80001970:	1b4080e7          	jalr	436(ra) # 80000b20 <kalloc>
    80001974:	85aa                	mv	a1,a0
      if(pa == 0)
    80001976:	c929                	beqz	a0,800019c8 <procinit+0xc0>
      uint64 va = KSTACK((int) (p - proc));
    80001978:	416904b3          	sub	s1,s2,s6
    8000197c:	8491                	srai	s1,s1,0x4
    8000197e:	000ab783          	ld	a5,0(s5)
    80001982:	02f484b3          	mul	s1,s1,a5
    80001986:	2485                	addiw	s1,s1,1
    80001988:	00d4949b          	slliw	s1,s1,0xd
    8000198c:	409984b3          	sub	s1,s3,s1
      kvmmap(va, (uint64)pa, PGSIZE, PTE_R | PTE_W);
    80001990:	4699                	li	a3,6
    80001992:	6605                	lui	a2,0x1
    80001994:	8526                	mv	a0,s1
    80001996:	00000097          	auipc	ra,0x0
    8000199a:	85c080e7          	jalr	-1956(ra) # 800011f2 <kvmmap>
      p->kstack = va;
    8000199e:	04993023          	sd	s1,64(s2)
  for(p = proc; p < &proc[NPROC]; p++) {
    800019a2:	17090913          	addi	s2,s2,368
    800019a6:	fb491de3          	bne	s2,s4,80001960 <procinit+0x58>
  kvminithart();
    800019aa:	fffff097          	auipc	ra,0xfffff
    800019ae:	650080e7          	jalr	1616(ra) # 80000ffa <kvminithart>
}
    ...
    800019cc:	81850513          	addi	a0,a0,-2024 # 800081e0 <digits+0x1a0>
    800019d0:	fffff097          	auipc	ra,0xfffff
    800019d4:	b78080e7          	jalr	-1160(ra) # 80000548 <panic>
...
mycpu(void) {
  ...
  struct cpu *c = &cpus[id];
    ...
    800019f8:	f7450513          	addi	a0,a0,-140 # 80011968 <cpus>
...
myproc(void) {
  ...
  push_off();
    ...
    80001a12:	1dc080e7          	jalr	476(ra) # 80000bea <push_off>
    80001a16:	8792                	mv	a5,tp
  struct proc *p = c->proc;
    80001a18:	2781                	sext.w	a5,a5
    80001a1a:	079e                	slli	a5,a5,0x7
    80001a1c:	00010717          	auipc	a4,0x10
    80001a20:	f3470713          	addi	a4,a4,-204 # 80011950 <pid_lock>
    80001a24:	97ba                	add	a5,a5,a4
    80001a26:	6f84                	ld	s1,24(a5)
  pop_off();
    80001a28:	fffff097          	auipc	ra,0xfffff
    80001a2c:	262080e7          	jalr	610(ra) # 80000c8a <pop_off>
}
...
0000000080001a3c <forkret>:
{
  ...
  release(&myproc()->lock);
    ...
    80001a50:	29e080e7          	jalr	670(ra) # 80000cea <release>
  if (first) {
    80001a54:	00007797          	auipc	a5,0x7
    80001a58:	f4c7a783          	lw	a5,-180(a5) # 800089a0 <first.1667>
    80001a5c:	eb89                	bnez	a5,80001a6e <forkret+0x32>
  usertrapret();
    80001a5e:	00001097          	auipc	ra,0x1
    80001a62:	c76080e7          	jalr	-906(ra) # 800026d4 <usertrapret>
}
    ...
    80001a72:	f207a923          	sw	zero,-206(a5) # 800089a0 <first.1667>
    fsinit(ROOTDEV);
    80001a76:	4505                	li	a0,1
    80001a78:	00002097          	auipc	ra,0x2
    80001a7c:	a76080e7          	jalr	-1418(ra) # 800034ee <fsinit>
...
allocpid() {
  ...
  acquire(&pid_lock);
    80001a8e:	00010917          	auipc	s2,0x10
    80001a92:	ec290913          	addi	s2,s2,-318 # 80011950 <pid_lock>
    80001a96:	854a                	mv	a0,s2
    80001a98:	fffff097          	auipc	ra,0xfffff
    80001a9c:	19e080e7          	jalr	414(ra) # 80000c36 <acquire>
  pid = nextpid;
    80001aa0:	00007797          	auipc	a5,0x7
    80001aa4:	f0478793          	addi	a5,a5,-252 # 800089a4 <nextpid>
  ...
  release(&pid_lock);
    ...
    80001ab6:	238080e7          	jalr	568(ra) # 80000cea <release>
}
...
0000000080001ac8 <proc_pagetable>:
{
  ...
  pagetable = uvmcreate();
    ...
    80001ada:	8ea080e7          	jalr	-1814(ra) # 800013c0 <uvmcreate>
  ...
  if(mappages(pagetable, TRAMPOLINE, PGSIZE,
    ...
    80001afa:	66e080e7          	jalr	1646(ra) # 80001164 <mappages>
  ...
  if(mappages(pagetable, TRAPFRAME, PGSIZE,
    ...
    80001b18:	650080e7          	jalr	1616(ra) # 80001164 <mappages>
    ...
    80001b36:	a8a080e7          	jalr	-1398(ra) # 800015bc <uvmfree>
    return 0;
    ...
    80001b50:	7b0080e7          	jalr	1968(ra) # 800012fc <uvmunmap>
    uvmfree(pagetable, 0);
    80001b54:	4581                	li	a1,0
    80001b56:	8526                	mv	a0,s1
    80001b58:	00000097          	auipc	ra,0x0
    80001b5c:	a64080e7          	jalr	-1436(ra) # 800015bc <uvmfree>
    return 0;
...
0000000080001b64 <proc_freepagetable>:
{
  ...
  uvmunmap(pagetable, TRAMPOLINE, 1, 0);
    ...
    80001b84:	77c080e7          	jalr	1916(ra) # 800012fc <uvmunmap>
  uvmunmap(pagetable, TRAPFRAME, 1, 0);
    ...
    80001b9a:	766080e7          	jalr	1894(ra) # 800012fc <uvmunmap>
  uvmfree(pagetable, sz);
    80001b9e:	85ca                	mv	a1,s2
    80001ba0:	8526                	mv	a0,s1
    80001ba2:	00000097          	auipc	ra,0x0
    80001ba6:	a1a080e7          	jalr	-1510(ra) # 800015bc <uvmfree>
}
...
0000000080001bb6 <freeproc>:
{
  ...
  if(p->trapframe)
    ...
    80001bca:	e5e080e7          	jalr	-418(ra) # 80000a24 <kfree>
  p->trapframe = 0;
  ...
  p->pid = 0;
    80001be8:	0204ac23          	sw	zero,56(s1)
  p->parent = 0;
    80001bec:	0204b023          	sd	zero,32(s1)
  p->name[0] = 0;
    80001bf0:	14048c23          	sb	zero,344(s1)
  p->chan = 0;
    80001bf4:	0204b423          	sd	zero,40(s1)
  p->killed = 0;
    80001bf8:	0204a823          	sw	zero,48(s1)
  p->xstate = 0;
    80001bfc:	0204aa23          	sw	zero,52(s1)
  p->state = UNUSED;
...
0000000080001c0e <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    80001c1a:	00010497          	auipc	s1,0x10
    80001c1e:	14e48493          	addi	s1,s1,334 # 80011d68 <proc>
    80001c22:	00016917          	auipc	s2,0x16
    80001c26:	d4690913          	addi	s2,s2,-698 # 80017968 <tickslock>
    acquire(&p->lock);
    80001c2a:	8526                	mv	a0,s1
    80001c2c:	fffff097          	auipc	ra,0xfffff
    80001c30:	00a080e7          	jalr	10(ra) # 80000c36 <acquire>
    if(p->state == UNUSED) {
  ...
  p->context.sp = p->kstack + PGSIZE;
    ...
    80001cae:	040080e7          	jalr	64(ra) # 80000cea <release>
    return 0;
    80001cb2:	84ca                	mv	s1,s2
    80001cb4:	b7dd                	j	80001c9a <allocproc+0x8c>
    freeproc(p);
    80001cb6:	8526                	mv	a0,s1
    80001cb8:	00000097          	auipc	ra,0x0
    80001cbc:	efe080e7          	jalr	-258(ra) # 80001bb6 <freeproc>
    release(&p->lock);
    80001cc0:	8526                	mv	a0,s1
    80001cc2:	fffff097          	auipc	ra,0xfffff
    80001cc6:	028080e7          	jalr	40(ra) # 80000cea <release>
    return 0;
    80001cca:	84ca                	mv	s1,s2
    80001ccc:	b7f9                	j	80001c9a <allocproc+0x8c>
...
0000000080001cce <userinit>:
{
  ...
  p = allocproc();
    ...
    80001cdc:	f36080e7          	jalr	-202(ra) # 80001c0e <allocproc>
    80001ce0:	84aa                	mv	s1,a0
  initproc = p;
    80001ce2:	00007797          	auipc	a5,0x7
    80001ce6:	32a7bb23          	sd	a0,822(a5) # 80009018 <initproc>
  uvminit(p->pagetable, initcode, sizeof(initcode));
    80001cea:	03400613          	li	a2,52
    80001cee:	00007597          	auipc	a1,0x7
    80001cf2:	cc258593          	addi	a1,a1,-830 # 800089b0 <initcode>
    80001cf6:	6928                	ld	a0,80(a0)
    80001cf8:	fffff097          	auipc	ra,0xfffff
    80001cfc:	6f6080e7          	jalr	1782(ra) # 800013ee <uvminit>
  p->sz = PGSIZE;
  ...
  safestrcpy(p->name, "initcode", sizeof(p->name));
    ...
    80001d14:	4d858593          	addi	a1,a1,1240 # 800081e8 <digits+0x1a8>
    80001d18:	15848513          	addi	a0,s1,344
    80001d1c:	fffff097          	auipc	ra,0xfffff
    80001d20:	16c080e7          	jalr	364(ra) # 80000e88 <safestrcpy>
  p->cwd = namei("/");
    80001d24:	00006517          	auipc	a0,0x6
    80001d28:	4d450513          	addi	a0,a0,1236 # 800081f8 <digits+0x1b8>
    80001d2c:	00002097          	auipc	ra,0x2
    80001d30:	1ea080e7          	jalr	490(ra) # 80003f16 <namei>
  ...
  release(&p->lock);
    ...
    80001d42:	fac080e7          	jalr	-84(ra) # 80000cea <release>
}
...
0000000080001d50 <growproc>:
{
  ...
  struct proc *p = myproc();
    ...
    80001d62:	ca6080e7          	jalr	-858(ra) # 80001a04 <myproc>
  ...
  return 0;
    ...
    80001d9c:	710080e7          	jalr	1808(ra) # 800014a8 <uvmalloc>
    ...
    80001dba:	6aa080e7          	jalr	1706(ra) # 80001460 <uvmdealloc>
...
0000000080001dc4 <fork>:
{
  ...
  struct proc *p = myproc();
    ...
    80001dd8:	c30080e7          	jalr	-976(ra) # 80001a04 <myproc>
    80001ddc:	892a                	mv	s2,a0
  if((np = allocproc()) == 0){
    80001dde:	00000097          	auipc	ra,0x0
    80001de2:	e30080e7          	jalr	-464(ra) # 80001c0e <allocproc>
    80001de6:	c575                	beqz	a0,80001ed2 <fork+0x10e>
  ...
  if(uvmcopy(p->pagetable, np->pagetable, p->sz) < 0){
    ...
    80001df8:	800080e7          	jalr	-2048(ra) # 800015f4 <uvmcopy>
    80001dfc:	04054c63          	bltz	a0,80001e54 <fork+0x90>
  np->sz = p->sz;
    80001e00:	04893783          	ld	a5,72(s2)
    80001e04:	04f9b423          	sd	a5,72(s3) # 4000048 <_entry-0x7bffffb8>
  np->mask=p->mask;
    80001e08:	16892783          	lw	a5,360(s2)
    80001e0c:	16f9a423          	sw	a5,360(s3)
  np->parent = p;
    80001e10:	0329b023          	sd	s2,32(s3)
  *(np->trapframe) = *(p->trapframe);
    80001e14:	05893683          	ld	a3,88(s2)
    80001e18:	87b6                	mv	a5,a3
    80001e1a:	0589b703          	ld	a4,88(s3)
    80001e1e:	12068693          	addi	a3,a3,288
    80001e22:	0007b803          	ld	a6,0(a5) # 1000 <_entry-0x7ffff000>
    80001e26:	6788                	ld	a0,8(a5)
    80001e28:	6b8c                	ld	a1,16(a5)
    80001e2a:	6f90                	ld	a2,24(a5)
    80001e2c:	01073023          	sd	a6,0(a4)
    80001e30:	e708                	sd	a0,8(a4)
    80001e32:	eb0c                	sd	a1,16(a4)
    80001e34:	ef10                	sd	a2,24(a4)
    80001e36:	02078793          	addi	a5,a5,32
    80001e3a:	02070713          	addi	a4,a4,32
    80001e3e:	fed792e3          	bne	a5,a3,80001e22 <fork+0x5e>
  np->trapframe->a0 = 0;
  ...
  for(i = 0; i < NOFILE; i++)
    ...
    80001e52:	a03d                	j	80001e80 <fork+0xbc>
    freeproc(np);
    80001e54:	854e                	mv	a0,s3
    80001e56:	00000097          	auipc	ra,0x0
    80001e5a:	d60080e7          	jalr	-672(ra) # 80001bb6 <freeproc>
    release(&np->lock);
    80001e5e:	854e                	mv	a0,s3
    80001e60:	fffff097          	auipc	ra,0xfffff
    80001e64:	e8a080e7          	jalr	-374(ra) # 80000cea <release>
    return -1;
    80001e68:	54fd                	li	s1,-1
    80001e6a:	a899                	j	80001ec0 <fork+0xfc>
      np->ofile[i] = filedup(p->ofile[i]);
    80001e6c:	00002097          	auipc	ra,0x2
    80001e70:	736080e7          	jalr	1846(ra) # 800045a2 <filedup>
    80001e74:	009987b3          	add	a5,s3,s1
    80001e78:	e388                	sd	a0,0(a5)
  for(i = 0; i < NOFILE; i++)
    80001e7a:	04a1                	addi	s1,s1,8
    80001e7c:	01448763          	beq	s1,s4,80001e8a <fork+0xc6>
    if(p->ofile[i])
    80001e80:	009907b3          	add	a5,s2,s1
    80001e84:	6388                	ld	a0,0(a5)
    80001e86:	f17d                	bnez	a0,80001e6c <fork+0xa8>
    80001e88:	bfcd                	j	80001e7a <fork+0xb6>
  np->cwd = idup(p->cwd);
    80001e8a:	15093503          	ld	a0,336(s2)
    80001e8e:	00002097          	auipc	ra,0x2
    80001e92:	89a080e7          	jalr	-1894(ra) # 80003728 <idup>
  ...
  safestrcpy(np->name, p->name, sizeof(p->name));
    ...
    80001ea8:	fe4080e7          	jalr	-28(ra) # 80000e88 <safestrcpy>
  pid = np->pid;
    80001eac:	0389a483          	lw	s1,56(s3)
  np->state = RUNNABLE;
  ...
  release(&np->lock);
    ...
    80001ebc:	e32080e7          	jalr	-462(ra) # 80000cea <release>
}
    ...
    80001ed4:	b7f5                	j	80001ec0 <fork+0xfc>
...
0000000080001ed6 <reparent>:
{
  ...
  for(pp = proc; pp < &proc[NPROC]; pp++){
    ...
    80001efc:	a7098993          	addi	s3,s3,-1424 # 80017968 <tickslock>
    80001f00:	a029                	j	80001f0a <reparent+0x34>
    80001f02:	17048493          	addi	s1,s1,368
    ...
    80001f16:	d24080e7          	jalr	-732(ra) # 80000c36 <acquire>
      pp->parent = initproc;
    ...
    80001f26:	dc8080e7          	jalr	-568(ra) # 80000cea <release>
...
0000000080001f3c <scheduler>:
{
  ...
  c->proc = 0;
    ...
    80001f60:	9f470713          	addi	a4,a4,-1548 # 80011950 <pid_lock>
    80001f64:	975a                	add	a4,a4,s6
    80001f66:	00073c23          	sd	zero,24(a4)
        swtch(&c->context, &p->context);
    80001f6a:	00010717          	auipc	a4,0x10
    80001f6e:	a0670713          	addi	a4,a4,-1530 # 80011970 <cpus+0x8>
    80001f72:	9b3a                	add	s6,s6,a4
        p->state = RUNNING;
    80001f74:	4c0d                	li	s8,3
        c->proc = p;
    80001f76:	079e                	slli	a5,a5,0x7
    80001f78:	00010a17          	auipc	s4,0x10
    80001f7c:	9d8a0a13          	addi	s4,s4,-1576 # 80011950 <pid_lock>
    80001f80:	9a3e                	add	s4,s4,a5
    for(p = proc; p < &proc[NPROC]; p++) {
    80001f82:	00016997          	auipc	s3,0x16
    80001f86:	9e698993          	addi	s3,s3,-1562 # 80017968 <tickslock>
        found = 1;
    80001f8a:	4b85                	li	s7,1
    80001f8c:	a899                	j	80001fe2 <scheduler+0xa6>
        p->state = RUNNING;
    80001f8e:	0184ac23          	sw	s8,24(s1)
        c->proc = p;
    ...
    80001fa0:	68e080e7          	jalr	1678(ra) # 8000262a <swtch>
        c->proc = 0;
    80001fa4:	000a3c23          	sd	zero,24(s4)
        found = 1;
    80001fa8:	8ade                	mv	s5,s7
      release(&p->lock);
    80001faa:	8526                	mv	a0,s1
    80001fac:	fffff097          	auipc	ra,0xfffff
    80001fb0:	d3e080e7          	jalr	-706(ra) # 80000cea <release>
    for(p = proc; p < &proc[NPROC]; p++) {
    80001fb4:	17048493          	addi	s1,s1,368
    80001fb8:	01348b63          	beq	s1,s3,80001fce <scheduler+0x92>
      acquire(&p->lock);
    80001fbc:	8526                	mv	a0,s1
    80001fbe:	fffff097          	auipc	ra,0xfffff
    80001fc2:	c78080e7          	jalr	-904(ra) # 80000c36 <acquire>
      if(p->state == RUNNABLE) {
    80001fc6:	4c9c                	lw	a5,24(s1)
    80001fc8:	ff2791e3          	bne	a5,s2,80001faa <scheduler+0x6e>
    80001fcc:	b7c9                	j	80001f8e <scheduler+0x52>
    if(found == 0) {
    80001fce:	000a9a63          	bnez	s5,80001fe2 <scheduler+0xa6>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    int found = 0;
    80001fee:	4a81                	li	s5,0
    for(p = proc; p < &proc[NPROC]; p++) {
    80001ff0:	00010497          	auipc	s1,0x10
    80001ff4:	d7848493          	addi	s1,s1,-648 # 80011d68 <proc>
      if(p->state == RUNNABLE) {
    80001ff8:	4909                	li	s2,2
    80001ffa:	b7c9                	j	80001fbc <scheduler+0x80>
...
0000000080001ffc <sched>:
{
  ...
  struct proc *p = myproc();
    ...
    8000200e:	9fa080e7          	jalr	-1542(ra) # 80001a04 <myproc>
    80002012:	84aa                	mv	s1,a0
  if(!holding(&p->lock))
    80002014:	fffff097          	auipc	ra,0xfffff
    80002018:	ba8080e7          	jalr	-1112(ra) # 80000bbc <holding>
  ...
  if(mycpu()->noff != 1)
    ...
    8000202e:	0907a703          	lw	a4,144(a5)
...
00000000800020d2 <exit>:
{
    ...
    800020de:	e052                	sd	s4,0(sp)
    800020e0:	1800                	addi	s0,sp,48
    800020e2:	8a2a                	mv	s4,a0
  struct proc *p = myproc();
    800020e4:	00000097          	auipc	ra,0x0
    800020e8:	920080e7          	jalr	-1760(ra) # 80001a04 <myproc>
    800020ec:	89aa                	mv	s3,a0
  if(p == initproc)
    800020ee:	00007797          	auipc	a5,0x7
    800020f2:	f2a7b783          	ld	a5,-214(a5) # 80009018 <initproc>
    800020f6:	0d050493          	addi	s1,a0,208
    800020fa:	15050913          	addi	s2,a0,336
    800020fe:	02a79363          	bne	a5,a0,80002124 <exit+0x52>
    panic("init exiting");
    80002102:	00006517          	auipc	a0,0x6
    80002106:	14650513          	addi	a0,a0,326 # 80008248 <digits+0x208>
    8000210a:	ffffe097          	auipc	ra,0xffffe
    8000210e:	43e080e7          	jalr	1086(ra) # 80000548 <panic>
      fileclose(f);
    80002112:	00002097          	auipc	ra,0x2
    80002116:	4e2080e7          	jalr	1250(ra) # 800045f4 <fileclose>
      p->ofile[fd] = 0;
    8000211a:	0004b023          	sd	zero,0(s1)
  for(int fd = 0; fd < NOFILE; fd++){
    8000211e:	04a1                	addi	s1,s1,8
    80002120:	01248563          	beq	s1,s2,8000212a <exit+0x58>
    if(p->ofile[fd]){
    80002124:	6088                	ld	a0,0(s1)
    80002126:	f575                	bnez	a0,80002112 <exit+0x40>
    80002128:	bfdd                	j	8000211e <exit+0x4c>
  begin_op();
    8000212a:	00002097          	auipc	ra,0x2
    8000212e:	ff8080e7          	jalr	-8(ra) # 80004122 <begin_op>
  iput(p->cwd);
    80002132:	1509b503          	ld	a0,336(s3)
    80002136:	00001097          	auipc	ra,0x1
    8000213a:	7ea080e7          	jalr	2026(ra) # 80003920 <iput>
  end_op();
    8000213e:	00002097          	auipc	ra,0x2
    80002142:	064080e7          	jalr	100(ra) # 800041a2 <end_op>
  p->cwd = 0;
  ...
  acquire(&initproc->lock);
    ...
    80002158:	ae2080e7          	jalr	-1310(ra) # 80000c36 <acquire>
  wakeup1(initproc);
    8000215c:	6088                	ld	a0,0(s1)
    8000215e:	fffff097          	auipc	ra,0xfffff
    80002162:	766080e7          	jalr	1894(ra) # 800018c4 <wakeup1>
  release(&initproc->lock);
    80002166:	6088                	ld	a0,0(s1)
    80002168:	fffff097          	auipc	ra,0xfffff
    8000216c:	b82080e7          	jalr	-1150(ra) # 80000cea <release>
  acquire(&p->lock);
    80002170:	854e                	mv	a0,s3
    80002172:	fffff097          	auipc	ra,0xfffff
    80002176:	ac4080e7          	jalr	-1340(ra) # 80000c36 <acquire>
  struct proc *original_parent = p->parent;
    8000217a:	0209b483          	ld	s1,32(s3)
  release(&p->lock);
    8000217e:	854e                	mv	a0,s3
    80002180:	fffff097          	auipc	ra,0xfffff
    80002184:	b6a080e7          	jalr	-1174(ra) # 80000cea <release>
  acquire(&original_parent->lock);
    80002188:	8526                	mv	a0,s1
    8000218a:	fffff097          	auipc	ra,0xfffff
    8000218e:	aac080e7          	jalr	-1364(ra) # 80000c36 <acquire>
  acquire(&p->lock);
    80002192:	854e                	mv	a0,s3
    80002194:	fffff097          	auipc	ra,0xfffff
    80002198:	aa2080e7          	jalr	-1374(ra) # 80000c36 <acquire>
  reparent(p);
    8000219c:	854e                	mv	a0,s3
    8000219e:	00000097          	auipc	ra,0x0
    800021a2:	d38080e7          	jalr	-712(ra) # 80001ed6 <reparent>
  wakeup1(original_parent);
    800021a6:	8526                	mv	a0,s1
    800021a8:	fffff097          	auipc	ra,0xfffff
    800021ac:	71c080e7          	jalr	1820(ra) # 800018c4 <wakeup1>
  p->xstate = status;
  ...
  release(&original_parent->lock);
    ...
    800021c0:	b2e080e7          	jalr	-1234(ra) # 80000cea <release>
  sched();
    800021c4:	00000097          	auipc	ra,0x0
    800021c8:	e38080e7          	jalr	-456(ra) # 80001ffc <sched>
  panic("zombie exit");
    800021cc:	00006517          	auipc	a0,0x6
    800021d0:	08c50513          	addi	a0,a0,140 # 80008258 <digits+0x218>
...
00000000800021dc <yield>:
{
  ...
  struct proc *p = myproc();
    ...
    800021ea:	81e080e7          	jalr	-2018(ra) # 80001a04 <myproc>
    800021ee:	84aa                	mv	s1,a0
  acquire(&p->lock);
    800021f0:	fffff097          	auipc	ra,0xfffff
    800021f4:	a46080e7          	jalr	-1466(ra) # 80000c36 <acquire>
  p->state = RUNNABLE;
    800021f8:	4789                	li	a5,2
    800021fa:	cc9c                	sw	a5,24(s1)
  sched();
    800021fc:	00000097          	auipc	ra,0x0
    80002200:	e00080e7          	jalr	-512(ra) # 80001ffc <sched>
  release(&p->lock);
    80002204:	8526                	mv	a0,s1
    80002206:	fffff097          	auipc	ra,0xfffff
    8000220a:	ae4080e7          	jalr	-1308(ra) # 80000cea <release>
}
...
0000000080002218 <sleep>:
{
  ...
  struct proc *p = myproc();
    ...
    8000222e:	7da080e7          	jalr	2010(ra) # 80001a04 <myproc>
    80002232:	84aa                	mv	s1,a0
  if(lk != &p->lock){  //DOC: sleeplock0
    80002234:	05250663          	beq	a0,s2,80002280 <sleep+0x68>
    acquire(&p->lock);  //DOC: sleeplock1
    80002238:	fffff097          	auipc	ra,0xfffff
    8000223c:	9fe080e7          	jalr	-1538(ra) # 80000c36 <acquire>
    release(lk);
    80002240:	854a                	mv	a0,s2
    80002242:	fffff097          	auipc	ra,0xfffff
    80002246:	aa8080e7          	jalr	-1368(ra) # 80000cea <release>
  p->chan = chan;
  ...
  sched();
    ...
    80002256:	daa080e7          	jalr	-598(ra) # 80001ffc <sched>
  p->chan = 0;
    8000225a:	0204b423          	sd	zero,40(s1)
    release(&p->lock);
    8000225e:	8526                	mv	a0,s1
    80002260:	fffff097          	auipc	ra,0xfffff
    80002264:	a8a080e7          	jalr	-1398(ra) # 80000cea <release>
    acquire(lk);
    80002268:	854a                	mv	a0,s2
    8000226a:	fffff097          	auipc	ra,0xfffff
    8000226e:	9cc080e7          	jalr	-1588(ra) # 80000c36 <acquire>
}
  ...
  sched();
    ...
    8000228c:	d74080e7          	jalr	-652(ra) # 80001ffc <sched>
  p->chan = 0;
...
0000000080002296 <wait>:
{
  ...
  struct proc *p = myproc();
    ...
    800022b4:	754080e7          	jalr	1876(ra) # 80001a04 <myproc>
    800022b8:	892a                	mv	s2,a0
  acquire(&p->lock);
    800022ba:	8c2a                	mv	s8,a0
    800022bc:	fffff097          	auipc	ra,0xfffff
    800022c0:	97a080e7          	jalr	-1670(ra) # 80000c36 <acquire>
    havekids = 0;
    ...
    800022cc:	6a098993          	addi	s3,s3,1696 # 80017968 <tickslock>
        havekids = 1;
    ...
    8000234a:	8f0080e7          	jalr	-1808(ra) # 80000c36 <acquire>
        if(np->state == ZOMBIE){
    ...
    8000235a:	994080e7          	jalr	-1644(ra) # 80000cea <release>
        havekids = 1;
    ...
    80002370:	97e080e7          	jalr	-1666(ra) # 80000cea <release>
      return -1;
...
000000008000239e <wakeup>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800023b6:	9b648493          	addi	s1,s1,-1610 # 80011d68 <proc>
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800023c2:	5aa90913          	addi	s2,s2,1450 # 80017968 <tickslock>
    ...
    800023d2:	91c080e7          	jalr	-1764(ra) # 80000cea <release>
  for(p = proc; p < &proc[NPROC]; p++) {
    800023d6:	17048493          	addi	s1,s1,368
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    8000241c:	95048493          	addi	s1,s1,-1712 # 80011d68 <proc>
    80002420:	00015997          	auipc	s3,0x15
    80002424:	54898993          	addi	s3,s3,1352 # 80017968 <tickslock>
    acquire(&p->lock);
    80002428:	8526                	mv	a0,s1
    8000242a:	fffff097          	auipc	ra,0xfffff
    8000242e:	80c080e7          	jalr	-2036(ra) # 80000c36 <acquire>
    if(p->pid == pid){
    ...
    8000243e:	8b0080e7          	jalr	-1872(ra) # 80000cea <release>
  for(p = proc; p < &proc[NPROC]; p++){
  ...
  return -1;
    ...
    80002460:	88e080e7          	jalr	-1906(ra) # 80000cea <release>
      return 0;
...
either_copyout(int user_dst, uint64 dst, void *src, uint64 len)
{
  ...
  struct proc *p = myproc();
    ...
    80002496:	572080e7          	jalr	1394(ra) # 80001a04 <myproc>
  if(user_dst){
    ...
    800024a8:	254080e7          	jalr	596(ra) # 800016f8 <copyout>
  } else {
    ...
    800024c8:	8ce080e7          	jalr	-1842(ra) # 80000d92 <memmove>
    return 0;
...
either_copyin(void *dst, int user_src, uint64 src, uint64 len)
{
  ...
  struct proc *p = myproc();
    ...
    800024ec:	51c080e7          	jalr	1308(ra) # 80001a04 <myproc>
  if(user_src){
    ...
    800024fe:	28a080e7          	jalr	650(ra) # 80001784 <copyin>
  } else {
    ...
    8000251e:	878080e7          	jalr	-1928(ra) # 80000d92 <memmove>
    return 0;
...
procdump(void)
{
  ...
  printf("\n");
    ...
    80002548:	04e080e7          	jalr	78(ra) # 80000592 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
    8000254c:	00010497          	auipc	s1,0x10
    80002550:	97448493          	addi	s1,s1,-1676 # 80011ec0 <proc+0x158>
    80002554:	00015917          	auipc	s2,0x15
    80002558:	56c90913          	addi	s2,s2,1388 # 80017ac0 <bcache+0x140>
    if(p->state == UNUSED)
      continue;
...
int proc_num(void){
    ...
    800025e8:	78448493          	addi	s1,s1,1924 # 80011d68 <proc>
    800025ec:	00015997          	auipc	s3,0x15
    800025f0:	37c98993          	addi	s3,s3,892 # 80017968 <tickslock>
  		acquire(&p->lock);
    800025f4:	8526                	mv	a0,s1
    800025f6:	ffffe097          	auipc	ra,0xffffe
    800025fa:	640080e7          	jalr	1600(ra) # 80000c36 <acquire>
		if(p->state!=UNUSED){
    800025fe:	4c9c                	lw	a5,24(s1)
			num++;
    80002600:	00f037b3          	snez	a5,a5
    80002604:	993e                	add	s2,s2,a5
		}
		release(&p->lock);
    80002606:	8526                	mv	a0,s1
    80002608:	ffffe097          	auipc	ra,0xffffe
    8000260c:	6e2080e7          	jalr	1762(ra) # 80000cea <release>
	for(p=proc;p<&proc[NPROC];p++){
    80002610:	17048493          	addi	s1,s1,368
    80002614:	ff3490e3          	bne	s1,s3,800025f4 <proc_num+0x20>
	}
	return num;
}
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    800026b0:	4fa080e7          	jalr	1274(ra) # 80000ba6 <initlock>
}
...
trapinithart(void)
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    800026c6:	59e78793          	addi	a5,a5,1438 # 80005c60 <kernelvec>
...
usertrapret(void)
{
  ...
  struct proc *p = myproc();
    ...
    800026e0:	328080e7          	jalr	808(ra) # 80001a04 <myproc>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
...
clockintr()
{
  ...
  acquire(&tickslock);
    ...
    8000278a:	4b0080e7          	jalr	1200(ra) # 80000c36 <acquire>
  ticks++;
  ...
  wakeup(&ticks);
    ...
    800027a0:	c02080e7          	jalr	-1022(ra) # 8000239e <wakeup>
  release(&tickslock);
    800027a4:	8526                	mv	a0,s1
    800027a6:	ffffe097          	auipc	ra,0xffffe
    800027aa:	544080e7          	jalr	1348(ra) # 80000cea <release>
}
...
devintr()
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    800027ee:	57e080e7          	jalr	1406(ra) # 80005d68 <plic_claim>
    ...
    8000281c:	574080e7          	jalr	1396(ra) # 80005d8c <plic_complete>
    return 1;
    ...
    80002832:	9f8080e7          	jalr	-1544(ra) # 80006226 <virtio_disk_intr>
    80002836:	b7c5                	j	80002816 <devintr+0x5e>
    if(cpuid() == 0){
    80002838:	fffff097          	auipc	ra,0xfffff
    8000283c:	1a0080e7          	jalr	416(ra) # 800019d8 <cpuid>
...
000000008000285a <usertrap>:
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    80002874:	3f078793          	addi	a5,a5,1008 # 80005c60 <kernelvec>
    80002878:	10579073          	csrw	stvec,a5
  struct proc *p = myproc();
    8000287c:	fffff097          	auipc	ra,0xfffff
    80002880:	188080e7          	jalr	392(ra) # 80001a04 <myproc>
  ...
  usertrapret();
    ...
    800028e6:	7f0080e7          	jalr	2032(ra) # 800020d2 <exit>
...
000000008000294e <kerneltrap>:
{
  ...
  if(which_dev == 2 && myproc() != 0 && myproc()->state == RUNNING)
    ...
    800029fa:	00e080e7          	jalr	14(ra) # 80001a04 <myproc>
    800029fe:	d541                	beqz	a0,80002986 <kerneltrap+0x38>
    80002a00:	fffff097          	auipc	ra,0xfffff
    80002a04:	004080e7          	jalr	4(ra) # 80001a04 <myproc>
    ...
    80002a14:	7cc080e7          	jalr	1996(ra) # 800021dc <yield>
...
argraw(int n)
{
  ...
  struct proc *p = myproc();
    ...
    80002a2a:	fde080e7          	jalr	-34(ra) # 80001a04 <myproc>
  switch (n) {
...
0000000080002a82 <fetchaddr>:
{
  ...
  struct proc *p = myproc();
    ...
    80002a96:	f72080e7          	jalr	-142(ra) # 80001a04 <myproc>
  ...
  if(copyin(p->pagetable, (char *)ip, addr, sizeof(*ip)) != 0)
    ...
    80002ab4:	cd4080e7          	jalr	-812(ra) # 80001784 <copyin>
...
0000000080002ad4 <fetchstr>:
{
  ...
  struct proc *p = myproc();
    ...
    80002aec:	f1c080e7          	jalr	-228(ra) # 80001a04 <myproc>
...
syscall(void)
{
  ...
  struct proc *p = myproc();
    ...
    80002ba2:	e66080e7          	jalr	-410(ra) # 80001a04 <myproc>
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    80002bb8:	04f76a63          	bltu	a4,a5,80002c0c <syscall+0x7c>
    ...
    80002bcc:	c3a1                	beqz	a5,80002c0c <syscall+0x7c>
    p->trapframe->a0 = syscalls[num]();
    80002bce:	9782                	jalr	a5
    80002bd0:	06a93823          	sd	a0,112(s2)
	if(p->mask&(1<<num)){
    80002bd4:	1684a783          	lw	a5,360(s1)
    80002bd8:	4137d7bb          	sraw	a5,a5,s3
    80002bdc:	8b85                	andi	a5,a5,1
    80002bde:	c7b1                	beqz	a5,80002c2a <syscall+0x9a>
		printf("%d: syscall %s -> %d\n",p->pid,syscall_names[num-1],p->trapframe->a0);
    80002be0:	6cb8                	ld	a4,88(s1)
    80002be2:	39fd                	addiw	s3,s3,-1
    80002be4:	00399793          	slli	a5,s3,0x3
    80002be8:	00006997          	auipc	s3,0x6
    80002bec:	90898993          	addi	s3,s3,-1784 # 800084f0 <syscalls>
    80002bf0:	99be                	add	s3,s3,a5
    80002bf2:	7b34                	ld	a3,112(a4)
    80002bf4:	0c09b603          	ld	a2,192(s3)
    80002bf8:	5c8c                	lw	a1,56(s1)
    80002bfa:	00005517          	auipc	a0,0x5
    80002bfe:	7f650513          	addi	a0,a0,2038 # 800083f0 <states.1707+0x148>
    80002c02:	ffffe097          	auipc	ra,0xffffe
    80002c06:	990080e7          	jalr	-1648(ra) # 80000592 <printf>
    80002c0a:	a005                	j	80002c2a <syscall+0x9a>
	}
  } else {
    printf("%d %s: unknown sys call %d\n",
    80002c0c:	86ce                	mv	a3,s3
    80002c0e:	15848613          	addi	a2,s1,344
    80002c12:	5c8c                	lw	a1,56(s1)
    80002c14:	00005517          	auipc	a0,0x5
    80002c18:	7f450513          	addi	a0,a0,2036 # 80008408 <states.1707+0x160>
    80002c1c:	ffffe097          	auipc	ra,0xffffe
    80002c20:	976080e7          	jalr	-1674(ra) # 80000592 <printf>
            p->pid, p->name, num);
    p->trapframe->a0 = -1;
...
sys_exit(void)
{
  ...
  if(argint(0, &n) < 0)
    ...
    80002c4a:	ed6080e7          	jalr	-298(ra) # 80002b1c <argint>
    return -1;
  ...
  exit(n);
    ...
    80002c5c:	47a080e7          	jalr	1146(ra) # 800020d2 <exit>
...
sys_getpid(void)
{
  ...
  return myproc()->pid;
    ...
    80002c78:	d90080e7          	jalr	-624(ra) # 80001a04 <myproc>
}
    80002c7c:	5d08                	lw	a0,56(a0)
...
sys_fork(void)
{
  ...
  return fork();
    ...
    80002c92:	136080e7          	jalr	310(ra) # 80001dc4 <fork>
}
...
sys_wait(void)
{
  ...
  if(argaddr(0, &p) < 0)
    ...
    80002cb0:	e92080e7          	jalr	-366(ra) # 80002b3e <argaddr>
  ...
  return wait(p);
    ...
    80002cc4:	5d6080e7          	jalr	1494(ra) # 80002296 <wait>
}
...
sys_sbrk(void)
{
  ...
  if(argint(0, &n) < 0)
    ...
    80002ce4:	e3c080e7          	jalr	-452(ra) # 80002b1c <argint>
  ...
  addr = myproc()->sz;
    ...
    80002cf4:	d14080e7          	jalr	-748(ra) # 80001a04 <myproc>
    80002cf8:	4524                	lw	s1,72(a0)
  if(growproc(n) < 0)
    80002cfa:	fdc42503          	lw	a0,-36(s0)
    80002cfe:	fffff097          	auipc	ra,0xfffff
    80002d02:	052080e7          	jalr	82(ra) # 80001d50 <growproc>
...
sys_sleep(void)
{
  ...
  if(argint(0, &n) < 0)
    ...
    80002d32:	dee080e7          	jalr	-530(ra) # 80002b1c <argint>
    return -1;
  ...
  acquire(&tickslock);
    ...
    80002d40:	c2c50513          	addi	a0,a0,-980 # 80017968 <tickslock>
    80002d44:	ffffe097          	auipc	ra,0xffffe
    80002d48:	ef2080e7          	jalr	-270(ra) # 80000c36 <acquire>
  ticks0 = ticks;
    80002d4c:	00006917          	auipc	s2,0x6
    80002d50:	2d492903          	lw	s2,724(s2) # 80009020 <ticks>
  while(ticks - ticks0 < n){
    ...
    80002d5a:	00015997          	auipc	s3,0x15
    80002d5e:	c0e98993          	addi	s3,s3,-1010 # 80017968 <tickslock>
    80002d62:	00006497          	auipc	s1,0x6
    80002d66:	2be48493          	addi	s1,s1,702 # 80009020 <ticks>
    if(myproc()->killed){
    80002d6a:	fffff097          	auipc	ra,0xfffff
    80002d6e:	c9a080e7          	jalr	-870(ra) # 80001a04 <myproc>
    80002d72:	591c                	lw	a5,48(a0)
    ...
    80002d7e:	49e080e7          	jalr	1182(ra) # 80002218 <sleep>
  while(ticks - ticks0 < n){
  ...
  release(&tickslock);
    ...
    80002d94:	bd850513          	addi	a0,a0,-1064 # 80017968 <tickslock>
    80002d98:	ffffe097          	auipc	ra,0xffffe
    80002d9c:	f52080e7          	jalr	-174(ra) # 80000cea <release>
  return 0;
    ...
    80002dbe:	f30080e7          	jalr	-208(ra) # 80000cea <release>
      return -1;
...
sys_kill(void)
{
  ...
  if(argint(0, &pid) < 0)
    ...
    80002dd8:	d48080e7          	jalr	-696(ra) # 80002b1c <argint>
  ...
  return kill(pid);
    ...
    80002dec:	620080e7          	jalr	1568(ra) # 80002408 <kill>
}
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    80002e06:	b6650513          	addi	a0,a0,-1178 # 80017968 <tickslock>
    80002e0a:	ffffe097          	auipc	ra,0xffffe
    80002e0e:	e2c080e7          	jalr	-468(ra) # 80000c36 <acquire>
  xticks = ticks;
    80002e12:	00006497          	auipc	s1,0x6
    80002e16:	20e4a483          	lw	s1,526(s1) # 80009020 <ticks>
  release(&tickslock);
    80002e1a:	00015517          	auipc	a0,0x15
    80002e1e:	b4e50513          	addi	a0,a0,-1202 # 80017968 <tickslock>
    80002e22:	ffffe097          	auipc	ra,0xffffe
    80002e26:	ec8080e7          	jalr	-312(ra) # 80000cea <release>
  return xticks;
}
...
sys_trace(void){
    ...
    80002e4c:	cd4080e7          	jalr	-812(ra) # 80002b1c <argint>
		return -1;	
    80002e50:	57fd                	li	a5,-1
	if(argint(0,&mask)<0){
    80002e52:	00054b63          	bltz	a0,80002e68 <sys_trace+0x2e>
	}
	struct proc *p=myproc();
    80002e56:	fffff097          	auipc	ra,0xfffff
    80002e5a:	bae080e7          	jalr	-1106(ra) # 80001a04 <myproc>
	p->mask=mask;
    80002e5e:	fec42783          	lw	a5,-20(s0)
    80002e62:	16f52423          	sw	a5,360(a0)
	return 0;
...
sys_sysinfo(void){
    ...
    80002e7a:	0080                	addi	s0,sp,64
	struct sysinfo info;
	uint64 addr;
	struct proc *p=myproc();
    80002e7c:	fffff097          	auipc	ra,0xfffff
    80002e80:	b88080e7          	jalr	-1144(ra) # 80001a04 <myproc>
    80002e84:	84aa                	mv	s1,a0
	if(argaddr(0,&addr)<0)
    80002e86:	fc840593          	addi	a1,s0,-56
    80002e8a:	4501                	li	a0,0
    80002e8c:	00000097          	auipc	ra,0x0
    80002e90:	cb2080e7          	jalr	-846(ra) # 80002b3e <argaddr>
		return -1;
    80002e94:	57fd                	li	a5,-1
	if(argaddr(0,&addr)<0)
    80002e96:	02054a63          	bltz	a0,80002eca <sys_sysinfo+0x58>
	info.freemem=freemem_size();
    80002e9a:	ffffe097          	auipc	ra,0xffffe
    80002e9e:	ce6080e7          	jalr	-794(ra) # 80000b80 <freemem_size>
    80002ea2:	fca43823          	sd	a0,-48(s0)
	info.nproc=proc_num();
    80002ea6:	fffff097          	auipc	ra,0xfffff
    80002eaa:	72e080e7          	jalr	1838(ra) # 800025d4 <proc_num>
    80002eae:	fca43c23          	sd	a0,-40(s0)
	if(copyout(p->pagetable,addr,(char*)&info,sizeof(info))<0)
    80002eb2:	46c1                	li	a3,16
    80002eb4:	fd040613          	addi	a2,s0,-48
    80002eb8:	fc843583          	ld	a1,-56(s0)
    80002ebc:	68a8                	ld	a0,80(s1)
    80002ebe:	fffff097          	auipc	ra,0xfffff
    80002ec2:	83a080e7          	jalr	-1990(ra) # 800016f8 <copyout>
    80002ec6:	43f55793          	srai	a5,a0,0x3f
		return -1;
	return 0;
}
...
binit(void)
{
  ...
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    ...
    80002f26:	74ea0a13          	addi	s4,s4,1870 # 80008670 <syscall_names+0xc0>
    b->next = bcache.head.next;
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    80002f82:	cb8080e7          	jalr	-840(ra) # 80000c36 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    ...
    80002fc2:	d2c080e7          	jalr	-724(ra) # 80000cea <release>
      acquiresleep(&b->lock);
  ...
  panic("bget: no buffers");
    ...
    80002ff8:	68450513          	addi	a0,a0,1668 # 80008678 <syscall_names+0xc8>
    ...
    80003020:	cce080e7          	jalr	-818(ra) # 80000cea <release>
      acquiresleep(&b->lock);
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    80003088:	60c50513          	addi	a0,a0,1548 # 80008690 <syscall_names+0xe0>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    800030c8:	b72080e7          	jalr	-1166(ra) # 80000c36 <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    80003112:	bdc080e7          	jalr	-1060(ra) # 80000cea <release>
}
    ...
    80003126:	57650513          	addi	a0,a0,1398 # 80008698 <syscall_names+0xe8>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    8000314a:	af0080e7          	jalr	-1296(ra) # 80000c36 <acquire>
  b->refcnt++;
  ...
  release(&bcache.lock);
    ...
    80003160:	b8e080e7          	jalr	-1138(ra) # 80000cea <release>
}
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    80003186:	ab4080e7          	jalr	-1356(ra) # 80000c36 <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    8000319c:	b52080e7          	jalr	-1198(ra) # 80000cea <release>
}
...
bfree(int dev, uint b)
{
  ...
  brelse(bp);
    ...
    8000321a:	48a50513          	addi	a0,a0,1162 # 800086a0 <syscall_names+0xf0>
...
0000000080003226 <balloc>:
{
  ...
  panic("balloc: out of blocks");
    ...
    800032e0:	3dc50513          	addi	a0,a0,988 # 800086b8 <syscall_names+0x108>
  ...
  memset(bp->data, 0, BSIZE);
    ...
    80003324:	a12080e7          	jalr	-1518(ra) # 80000d32 <memset>
  log_write(bp);
...
bmap(struct inode *ip, uint bn)
{
  ...
  panic("bmap: out of range");
    ...
    80003426:	2ae50513          	addi	a0,a0,686 # 800086d0 <syscall_names+0x120>
...
0000000080003432 <iget>:
{
  ...
  acquire(&icache.lock);
    ...
    80003452:	7e8080e7          	jalr	2024(ra) # 80000c36 <acquire>
  empty = 0;
  ...
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
    ...
    80003498:	856080e7          	jalr	-1962(ra) # 80000cea <release>
      return ip;
  ...
  release(&icache.lock);
    ...
    800034c8:	826080e7          	jalr	-2010(ra) # 80000cea <release>
}
    ...
    800034e2:	20a50513          	addi	a0,a0,522 # 800086e8 <syscall_names+0x138>
...
fsinit(int dev) {
  ...
  memmove(sb, bp->data, sizeof(*sb));
    ...
    80003520:	876080e7          	jalr	-1930(ra) # 80000d92 <memmove>
  brelse(bp);
  ...
  initlog(dev, &sb);
    ...
    80003562:	19a50513          	addi	a0,a0,410 # 800086f8 <syscall_names+0x148>
...
000000008000356e <iinit>:
{
  ...
  for(i = 0; i < NINODE; i++) {
    ...
    800035a8:	17490913          	addi	s2,s2,372 # 80008718 <syscall_names+0x168>
...
00000000800035ce <ialloc>:
{
  ...
  panic("ialloc: no inodes");
    ...
    80003646:	0de50513          	addi	a0,a0,222 # 80008720 <syscall_names+0x170>
    ...
    8000365e:	6d8080e7          	jalr	1752(ra) # 80000d32 <memset>
      dip->type = type;
...
000000008000369c <iupdate>:
{
  ...
  memmove(dip->addrs, ip->addrs, sizeof(ip->addrs));
    ...
    80003704:	692080e7          	jalr	1682(ra) # 80000d92 <memmove>
  log_write(bp);
...
0000000080003728 <idup>:
{
  ...
  acquire(&icache.lock);
    ...
    80003740:	4fa080e7          	jalr	1274(ra) # 80000c36 <acquire>
  ip->ref++;
  ...
  release(&icache.lock);
    ...
    80003756:	598080e7          	jalr	1432(ra) # 80000cea <release>
}
...
0000000080003766 <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    8000379a:	fa250513          	addi	a0,a0,-94 # 80008738 <syscall_names+0x188>
    ...
    80003800:	596080e7          	jalr	1430(ra) # 80000d92 <memmove>
    brelse(bp);
    ...
    8000381c:	f2850513          	addi	a0,a0,-216 # 80008740 <syscall_names+0x190>
...
0000000080003828 <iunlock>:
{
  ...
  releasesleep(&ip->lock);
    ...
    80003868:	eec50513          	addi	a0,a0,-276 # 80008750 <syscall_names+0x1a0>
...
0000000080003920 <iput>:
{
  ...
  acquire(&icache.lock);
    ...
    8000393a:	300080e7          	jalr	768(ra) # 80000c36 <acquire>
  ...
  release(&icache.lock);
    ...
    80003958:	396080e7          	jalr	918(ra) # 80000cea <release>
}
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    8000398c:	362080e7          	jalr	866(ra) # 80000cea <release>
    itrunc(ip);
    ...
    800039c2:	278080e7          	jalr	632(ra) # 80000c36 <acquire>
    ...
    80003a1c:	0ed7e863          	bltu	a5,a3,80003b0c <readi+0xf2>
{
  ...
  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    ...
    80003a7e:	a00080e7          	jalr	-1536(ra) # 8000247a <either_copyout>
    ...
    80003b12:	10d7e663          	bltu	a5,a3,80003c1e <writei+0x10e>
{
  ...
  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    ...
    80003b74:	960080e7          	jalr	-1696(ra) # 800024d0 <either_copyin>
...
namecmp(const char *s, const char *t)
{
  ...
  return strncmp(s, t, DIRSIZ);
    ...
    80003c38:	1da080e7          	jalr	474(ra) # 80000e0e <strncmp>
}
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    80003c72:	aea50513          	addi	a0,a0,-1302 # 80008758 <syscall_names+0x1a8>
    80003c76:	ffffd097          	auipc	ra,0xffffd
    80003c7a:	8d2080e7          	jalr	-1838(ra) # 80000548 <panic>
      panic("dirlookup read");
    80003c7e:	00005517          	auipc	a0,0x5
    80003c82:	af250513          	addi	a0,a0,-1294 # 80008770 <syscall_names+0x1c0>
...
namex(char *path, int nameiparent, char *name)
{
  ...
  if(*path == '/')
    ...
    80003d24:	ce4080e7          	jalr	-796(ra) # 80001a04 <myproc>
  ...
  if(len >= DIRSIZ)
    ...
    80003da8:	fee080e7          	jalr	-18(ra) # 80000d92 <memmove>
  while(*path == '/')
  ...
  while(*path != '/' && *path != 0)
    ...
    80003e2c:	f6a080e7          	jalr	-150(ra) # 80000d92 <memmove>
    name[len] = 0;
...
0000000080003e54 <dirlink>:
{
  ...
  strncpy(de.name, name, DIRSIZ);
    ...
    80003eb4:	f9a080e7          	jalr	-102(ra) # 80000e4a <strncpy>
  de.inum = inum;
  ...
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    80003efa:	88a50513          	addi	a0,a0,-1910 # 80008780 <syscall_names+0x1d0>
    80003efe:	ffffc097          	auipc	ra,0xffffc
    80003f02:	64a080e7          	jalr	1610(ra) # 80000548 <panic>
    panic("dirlink");
    80003f06:	00005517          	auipc	a0,0x5
    80003f0a:	99250513          	addi	a0,a0,-1646 # 80008898 <syscall_names+0x2e8>
    ...
    80003fd2:	0af05663          	blez	a5,8000407e <install_trans+0xb4>
{
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80004034:	d62080e7          	jalr	-670(ra) # 80000d92 <memmove>
...
0000000080004080 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    8000409e:	6f658593          	addi	a1,a1,1782 # 80008790 <syscall_names+0x1e0>
    800040a2:	8526                	mv	a0,s1
    800040a4:	ffffd097          	auipc	ra,0xffffd
    800040a8:	b02080e7          	jalr	-1278(ra) # 80000ba6 <initlock>
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    ...
    8000413a:	b00080e7          	jalr	-1280(ra) # 80000c36 <acquire>
  while(1){
    if(log.committing){
    ...
    80004152:	0ca080e7          	jalr	202(ra) # 80002218 <sleep>
    if(log.committing){
    ...
    8000417e:	09e080e7          	jalr	158(ra) # 80002218 <sleep>
    ...
    80004192:	b5c080e7          	jalr	-1188(ra) # 80000cea <release>
      break;
    }
  }
}
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    800041c2:	a78080e7          	jalr	-1416(ra) # 80000c36 <acquire>
  log.outstanding -= 1;
  ...
  release(&log.lock);
    ...
    800041ea:	b04080e7          	jalr	-1276(ra) # 80000cea <release>
}
...
commit()
{
  if (log.lh.n > 0) {
    ...
    80004234:	56850513          	addi	a0,a0,1384 # 80008798 <syscall_names+0x1e8>
    ...
    8000424e:	154080e7          	jalr	340(ra) # 8000239e <wakeup>
  release(&log.lock);
    80004252:	8526                	mv	a0,s1
    80004254:	ffffd097          	auipc	ra,0xffffd
    80004258:	a96080e7          	jalr	-1386(ra) # 80000cea <release>
  if(do_commit){
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    800042a8:	aee080e7          	jalr	-1298(ra) # 80000d92 <memmove>
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    8000433c:	8fe080e7          	jalr	-1794(ra) # 80000c36 <acquire>
  for (i = 0; i < log.lh.n; i++) {
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    80004392:	41a50513          	addi	a0,a0,1050 # 800087a8 <syscall_names+0x1f8>
    80004396:	ffffc097          	auipc	ra,0xffffc
    8000439a:	1b2080e7          	jalr	434(ra) # 80000548 <panic>
    panic("log_write outside of trans");
    8000439e:	00004517          	auipc	a0,0x4
    800043a2:	42250513          	addi	a0,a0,1058 # 800087c0 <syscall_names+0x210>
  ...
  release(&log.lock);
    ...
    800043d6:	918080e7          	jalr	-1768(ra) # 80000cea <release>
}
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    800043fa:	3ea58593          	addi	a1,a1,1002 # 800087e0 <syscall_names+0x230>
    800043fe:	0521                	addi	a0,a0,8
    80004400:	ffffc097          	auipc	ra,0xffffc
    80004404:	7a6080e7          	jalr	1958(ra) # 80000ba6 <initlock>
  lk->name = name;
...
acquiresleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    80004438:	802080e7          	jalr	-2046(ra) # 80000c36 <acquire>
  while (lk->locked) {
    ...
    80004448:	dd4080e7          	jalr	-556(ra) # 80002218 <sleep>
  while (lk->locked) {
...
releasesleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    8000448e:	7ac080e7          	jalr	1964(ra) # 80000c36 <acquire>
  lk->locked = 0;
  ...
  wakeup(lk);
    ...
    800044a0:	f02080e7          	jalr	-254(ra) # 8000239e <wakeup>
  release(&lk->lk);
    800044a4:	854a                	mv	a0,s2
    800044a6:	ffffd097          	auipc	ra,0xffffd
    800044aa:	844080e7          	jalr	-1980(ra) # 80000cea <release>
}
...
holdingsleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    800044d4:	766080e7          	jalr	1894(ra) # 80000c36 <acquire>
  ...
  release(&lk->lk);
    ...
    800044e4:	80a080e7          	jalr	-2038(ra) # 80000cea <release>
  return r;
}
  ...
  r = lk->locked && (lk->pid == myproc()->pid);
    ...
    80004500:	508080e7          	jalr	1288(ra) # 80001a04 <myproc>
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    8000454e:	6ec080e7          	jalr	1772(ra) # 80000c36 <acquire>
  ...
  release(&ftable.lock);
    ...
    8000457a:	774080e7          	jalr	1908(ra) # 80000cea <release>
  return 0;
    ...
    80004592:	75c080e7          	jalr	1884(ra) # 80000cea <release>
}
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    800045ba:	680080e7          	jalr	1664(ra) # 80000c36 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    800045d4:	71a080e7          	jalr	1818(ra) # 80000cea <release>
  return f;
}
    ...
    800045e8:	21450513          	addi	a0,a0,532 # 800087f8 <syscall_names+0x248>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80004614:	626080e7          	jalr	1574(ra) # 80000c36 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    8000464e:	6a0080e7          	jalr	1696(ra) # 80000cea <release>
  ...
  if(ff.type == FD_PIPE){
    ...
    80004680:	18450513          	addi	a0,a0,388 # 80008800 <syscall_names+0x250>
    ...
    80004698:	656080e7          	jalr	1622(ra) # 80000cea <release>
  }
}
...
filestat(struct file *f, uint64 addr)
{
  ...
  struct proc *p = myproc();
    ...
    800046d2:	336080e7          	jalr	822(ra) # 80001a04 <myproc>
  struct stat st;
  ...
  if(f->type == FD_INODE || f->type == FD_DEVICE){
    ...
    80004714:	fe8080e7          	jalr	-24(ra) # 800016f8 <copyout>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    800047d8:	03c50513          	addi	a0,a0,60 # 80008810 <syscall_names+0x260>
    ...
    800047f4:	14078563          	beqz	a5,8000493e <filewrite+0x14e>
{
  ...
  return ret;
    ...
    8000491a:	f0a50513          	addi	a0,a0,-246 # 80008820 <syscall_names+0x270>
    ...
    80004932:	f0250513          	addi	a0,a0,-254 # 80008830 <syscall_names+0x280>
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    800049aa:	200080e7          	jalr	512(ra) # 80000ba6 <initlock>
  (*f0)->type = FD_PIPE;
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  acquire(&pi->lock);
    ...
    80004a38:	202080e7          	jalr	514(ra) # 80000c36 <acquire>
  if(writable){
    ...
    80004a4c:	956080e7          	jalr	-1706(ra) # 8000239e <wakeup>
  } else {
    pi->readopen = 0;
    wakeup(&pi->nwrite);
  }
  if(pi->readopen == 0 && pi->writeopen == 0){
    ...
    80004a5c:	292080e7          	jalr	658(ra) # 80000cea <release>
    kfree((char*)pi);
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  struct proc *pr = myproc();
    ...
    80004abc:	f4c080e7          	jalr	-180(ra) # 80001a04 <myproc>
    80004ac0:	892a                	mv	s2,a0

  acquire(&pi->lock);
    80004ac2:	8526                	mv	a0,s1
    80004ac4:	ffffc097          	auipc	ra,0xffffc
    80004ac8:	172080e7          	jalr	370(ra) # 80000c36 <acquire>
  for(i = 0; i < n; i++){
    ...
    80004b0e:	894080e7          	jalr	-1900(ra) # 8000239e <wakeup>
      sleep(&pi->nwrite, &pi->lock);
    80004b12:	85ce                	mv	a1,s3
    80004b14:	8552                	mv	a0,s4
    80004b16:	ffffd097          	auipc	ra,0xffffd
    80004b1a:	702080e7          	jalr	1794(ra) # 80002218 <sleep>
    while(pi->nwrite == pi->nread + PIPESIZE){  //DOC: pipewrite-full
    ...
    80004b40:	c48080e7          	jalr	-952(ra) # 80001784 <copyin>
  ...
  for(i = 0; i < n; i++){
    ...
    80004b78:	176080e7          	jalr	374(ra) # 80000cea <release>
        return -1;
  ...
  wakeup(&pi->nread);
    ...
    80004ba8:	7fa080e7          	jalr	2042(ra) # 8000239e <wakeup>
  release(&pi->lock);
    80004bac:	8526                	mv	a0,s1
    80004bae:	ffffc097          	auipc	ra,0xffffc
    80004bb2:	13c080e7          	jalr	316(ra) # 80000cea <release>
  return i;
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  struct proc *pr = myproc();
    ...
    80004bd6:	e32080e7          	jalr	-462(ra) # 80001a04 <myproc>
  ...
  acquire(&pi->lock);
    ...
    80004be4:	056080e7          	jalr	86(ra) # 80000c36 <acquire>
  ...
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
    ...
    80004c0c:	610080e7          	jalr	1552(ra) # 80002218 <sleep>
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
  ...
  for(i = 0; i < n; i++){  //DOC: piperead-copy
    ...
    80004c56:	aa6080e7          	jalr	-1370(ra) # 800016f8 <copyout>
  ...
  wakeup(&pi->nwrite);  //DOC: piperead-wakeup
    ...
    80004c6e:	734080e7          	jalr	1844(ra) # 8000239e <wakeup>
  release(&pi->lock);
    80004c72:	8526                	mv	a0,s1
    80004c74:	ffffc097          	auipc	ra,0xffffc
    80004c78:	076080e7          	jalr	118(ra) # 80000cea <release>
  return i;
}
    ...
    80004c98:	056080e7          	jalr	86(ra) # 80000cea <release>
      return -1;
...
exec(char *path, char **argv)
{
  ...
  struct proc *p = myproc();
    ...
    80004cd6:	d32080e7          	jalr	-718(ra) # 80001a04 <myproc>
 ...
 bad:
  ...
  if((pagetable = proc_pagetable(p)) == 0)
    ...
    80004d72:	d5a080e7          	jalr	-678(ra) # 80001ac8 <proc_pagetable>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80004d98:	aac50513          	addi	a0,a0,-1364 # 80008840 <syscall_names+0x290>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80004dda:	2ee080e7          	jalr	750(ra) # 800010c4 <walkaddr>
  ...
  p = myproc();
    ...
    80004e04:	c04080e7          	jalr	-1020(ra) # 80001a04 <myproc>
  ...
  if((sz1 = uvmalloc(pagetable, sz, sz + 2*PGSIZE)) == 0)
    ...
    80004e2a:	682080e7          	jalr	1666(ra) # 800014a8 <uvmalloc>
  ...
  uvmclear(pagetable, sz-2*PGSIZE);
    ...
    80004e40:	88a080e7          	jalr	-1910(ra) # 800016c6 <uvmclear>
  stackbase = sp - PGSIZE;
  ...
  sp = sz;
    ...
    80004e5e:	060080e7          	jalr	96(ra) # 80000eba <strlen>
    ...
    80004e7e:	040080e7          	jalr	64(ra) # 80000eba <strlen>
    ...
    80004e90:	86c080e7          	jalr	-1940(ra) # 800016f8 <copyout>
  ...
  if(copyout(pagetable, sp, (char *)ustack, (argc+1)*sizeof(uint64)) < 0)
    ...
    80004ef2:	80a080e7          	jalr	-2038(ra) # 800016f8 <copyout>
  ...
  safestrcpy(p->name, last, sizeof(p->name));
    ...
    80004f34:	f58080e7          	jalr	-168(ra) # 80000e88 <safestrcpy>
  ...
  proc_freepagetable(oldpagetable, oldsz);
    ...
    80004f5c:	c0c080e7          	jalr	-1012(ra) # 80001b64 <proc_freepagetable>
  return argc; // this ends up in a0, the first argument to main(argc, argv)
    ...
    80004f74:	bf4080e7          	jalr	-1036(ra) # 80001b64 <proc_freepagetable>
  if(ip){
  ...
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    ...
    80005004:	4a8080e7          	jalr	1192(ra) # 800014a8 <uvmalloc>
...
argfd(int n, int *pfd, struct file **pf)
{
  ...
  if(argint(n, &fd) < 0)
    ...
    80005046:	ada080e7          	jalr	-1318(ra) # 80002b1c <argint>
  ...
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
    ...
    8000505c:	9ac080e7          	jalr	-1620(ra) # 80001a04 <myproc>
...
fdalloc(struct file *f)
{
  ...
  struct proc *p = myproc();
    ...
    800050a6:	962080e7          	jalr	-1694(ra) # 80001a04 <myproc>
...
create(char *path, short type, short major, short minor)
{
  ...
  return ip;
    ...
    800051ca:	69a50513          	addi	a0,a0,1690 # 80008860 <syscall_names+0x2b0>
    ...
    800051f0:	68458593          	addi	a1,a1,1668 # 80008870 <syscall_names+0x2c0>
    ...
    8000520a:	67258593          	addi	a1,a1,1650 # 80008878 <syscall_names+0x2c8>
    ...
    80005220:	66450513          	addi	a0,a0,1636 # 80008880 <syscall_names+0x2d0>
    80005224:	ffffb097          	auipc	ra,0xffffb
    80005228:	324080e7          	jalr	804(ra) # 80000548 <panic>
    panic("create: dirlink");
    8000522c:	00003517          	auipc	a0,0x3
    80005230:	66450513          	addi	a0,a0,1636 # 80008890 <syscall_names+0x2e0>
...
000000008000528e <sys_read>:
{
  ...
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    ...
    800052b6:	86a080e7          	jalr	-1942(ra) # 80002b1c <argint>
    return -1;
  ...
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    ...
    800052ca:	878080e7          	jalr	-1928(ra) # 80002b3e <argaddr>
    return -1;
...
00000000800052f4 <sys_write>:
{
  ...
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    ...
    8000531c:	804080e7          	jalr	-2044(ra) # 80002b1c <argint>
    return -1;
  ...
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    ...
    80005330:	812080e7          	jalr	-2030(ra) # 80002b3e <argaddr>
    return -1;
...
000000008000535a <sys_close>:
{
  ...
  myproc()->ofile[fd] = 0;
    ...
    8000537e:	68a080e7          	jalr	1674(ra) # 80001a04 <myproc>
...
00000000800053a8 <sys_fstat>:
{
  ...
  if(argfd(0, 0, &f) < 0 || argaddr(1, &st) < 0)
    ...
    800053d0:	772080e7          	jalr	1906(ra) # 80002b3e <argaddr>
    return -1;
...
00000000800053f6 <sys_link>:
{
  ...
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    ...
    80005410:	754080e7          	jalr	1876(ra) # 80002b60 <argstr>
    return -1;
  ...
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    ...
    80005428:	73c080e7          	jalr	1852(ra) # 80002b60 <argstr>
    return -1;
...
0000000080005540 <sys_unlink>:
{
  ...
  if(argstr(0, path, MAXPATH) < 0)
    ...
    8000555c:	608080e7          	jalr	1544(ra) # 80002b60 <argstr>
  ...
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    ...
    8000558c:	2e858593          	addi	a1,a1,744 # 80008870 <syscall_names+0x2c0>
    ...
    800055a4:	2d858593          	addi	a1,a1,728 # 80008878 <syscall_names+0x2c8>
  ...
  memset(&de, 0, sizeof(de));
    ...
    800055f6:	740080e7          	jalr	1856(ra) # 80000d32 <memset>
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
  ...
  return 0;
    ...
    80005664:	24050513          	addi	a0,a0,576 # 800088a0 <syscall_names+0x2f0>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    ...
    800056b0:	20c50513          	addi	a0,a0,524 # 800088b8 <syscall_names+0x308>
    800056b4:	ffffb097          	auipc	ra,0xffffb
    800056b8:	e94080e7          	jalr	-364(ra) # 80000548 <panic>
    panic("unlink: writei");
    800056bc:	00003517          	auipc	a0,0x3
    800056c0:	21450513          	addi	a0,a0,532 # 800088d0 <syscall_names+0x320>
...
sys_open(void)
{
  ...
  if((n = argstr(0, path, MAXPATH)) < 0 || argint(1, &omode) < 0)
    ...
    8000572e:	436080e7          	jalr	1078(ra) # 80002b60 <argstr>
    return -1;
  ...
  if((n = argstr(0, path, MAXPATH)) < 0 || argint(1, &omode) < 0)
    ...
    80005742:	3de080e7          	jalr	990(ra) # 80002b1c <argint>
...
sys_mkdir(void)
{
  ...
  if(argstr(0, path, MAXPATH) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
    ...
    800058c8:	29c080e7          	jalr	668(ra) # 80002b60 <argstr>
...
sys_mknod(void)
{
  ...
  if((argstr(0, path, MAXPATH)) < 0 ||
    ...
    80005928:	23c080e7          	jalr	572(ra) # 80002b60 <argstr>
    ...
    8000593a:	1e6080e7          	jalr	486(ra) # 80002b1c <argint>
  if((argstr(0, path, MAXPATH)) < 0 ||
    ...
    8000594c:	1d4080e7          	jalr	468(ra) # 80002b1c <argint>
     argint(1, &major) < 0 ||
...
sys_chdir(void)
{
  ...
  struct proc *p = myproc();
    ...
    800059a2:	066080e7          	jalr	102(ra) # 80001a04 <myproc>
  ...
  if(argstr(0, path, MAXPATH) < 0 || (ip = namei(path)) == 0){
    ...
    800059be:	1a6080e7          	jalr	422(ra) # 80002b60 <argstr>
...
sys_exec(void)
{
  ...
  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    ...
    80005a5a:	10a080e7          	jalr	266(ra) # 80002b60 <argstr>
    return -1;
  ...
  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    ...
    80005a6e:	0d4080e7          	jalr	212(ra) # 80002b3e <argaddr>
  ...
  memset(argv, 0, sizeof(argv));
    ...
    80005a84:	2b2080e7          	jalr	690(ra) # 80000d32 <memset>
  for(i=0;; i++){
    if(i >= NELEM(argv)){
  ...
  memset(argv, 0, sizeof(argv));
    ...
    80005aaa:	fdc080e7          	jalr	-36(ra) # 80002a82 <fetchaddr>
    ...
    80005ad2:	006080e7          	jalr	6(ra) # 80002ad4 <fetchstr>
...
sys_pipe(void)
{
  ...
  struct proc *p = myproc();
    ...
    80005b56:	eb2080e7          	jalr	-334(ra) # 80001a04 <myproc>
  ...
  if(argaddr(0, &fdarray) < 0)
    ...
    80005b66:	fdc080e7          	jalr	-36(ra) # 80002b3e <argaddr>
    return -1;
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    ...
    80005bc2:	b3a080e7          	jalr	-1222(ra) # 800016f8 <copyout>
    ...
    80005bdc:	b20080e7          	jalr	-1248(ra) # 800016f8 <copyout>
    p->ofile[fd1] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
...
0000000080005c60 <kernelvec>:
    ...
    80005ca0:	caffc0ef          	jal	ra,8000294e <kerneltrap>
...
plicinithart(void)
{
  ...
  int hart = cpuid();
    ...
    80005d3c:	ca0080e7          	jalr	-864(ra) # 800019d8 <cpuid>
...
plic_claim(void)
{
  ...
  int hart = cpuid();
    ...
    80005d74:	c68080e7          	jalr	-920(ra) # 800019d8 <cpuid>
...
plic_complete(int irq)
{
  ...
  int hart = cpuid();
    ...
    80005d9c:	c40080e7          	jalr	-960(ra) # 800019d8 <cpuid>
...
free_desc(int i)
{
  ...
  wakeup(&disk.free[0]);
    ...
    80005e0c:	596080e7          	jalr	1430(ra) # 8000239e <wakeup>
}
    ...
    80005e1c:	ac850513          	addi	a0,a0,-1336 # 800088e0 <syscall_names+0x330>
    80005e20:	ffffa097          	auipc	ra,0xffffa
    80005e24:	728080e7          	jalr	1832(ra) # 80000548 <panic>
    panic("virtio_disk_intr 2");
    80005e28:	00003517          	auipc	a0,0x3
    80005e2c:	ad050513          	addi	a0,a0,-1328 # 800088f8 <syscall_names+0x348>
...
0000000080005e38 <virtio_disk_init>:
{
  ...
  *R(VIRTIO_MMIO_QUEUE_NUM) = NUM;
  ...
  memset(disk.pages, 0, sizeof(disk.pages));
    ...
    80005eee:	e48080e7          	jalr	-440(ra) # 80000d32 <memset>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    80005fb6:	c84080e7          	jalr	-892(ra) # 80000c36 <acquire>
  for(int i = 0; i < 3; i++){
  ...
  while(1){
    ...
    8000604c:	1d0080e7          	jalr	464(ra) # 80002218 <sleep>
  for(int i = 0; i < 3; i++){
  ...
  disk.desc[idx[0]].addr = (uint64) kvmpa((uint64) &buf0);
    ...
    80006084:	086080e7          	jalr	134(ra) # 80001106 <kvmpa>
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    80006190:	08c080e7          	jalr	140(ra) # 80002218 <sleep>
  while(b->disk == 1) {
  ...
  release(&disk.vdisk_lock);
    ...
    800061fc:	af2080e7          	jalr	-1294(ra) # 80000cea <release>
}
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    8000623e:	9fc080e7          	jalr	-1540(ra) # 80000c36 <acquire>
  ...
  while((disk.used_idx % NUM) != (disk.used->id % NUM)){
    ...
    80006292:	110080e7          	jalr	272(ra) # 8000239e <wakeup>
    disk.used_idx = (disk.used_idx + 1) % NUM;
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    ...
    800062c4:	a2a080e7          	jalr	-1494(ra) # 80000cea <release>
}
    ...
    800062d8:	6ac50513          	addi	a0,a0,1708 # 80008980 <syscall_names+0x3d0>
